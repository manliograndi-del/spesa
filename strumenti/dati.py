...
PDF = {
 ...
 # MD di corso Sebastopoli 227/A: edizione «nord-atm-na-gastro» (senza la
 # pagina della gastronomia al banco). Il PDF non ha testo: si legge a occhio.
 'md22':    'https://www.mdspa.it/cdn/upload/presente/volantini/nord-atm-na-gastro/volantino.pdf',
 # Bennet «Offerte Extra»: c'è solo in PDF (sul sito Bennet, col testo dentro).
...
VOLANTINI = [
 ...
 _v('carraia29',      'Carrefour Iper', '«Speciale Aia», dal 29 settembre al 15 novembre', 'Carrefour Iper — Speciale Aia.pdf', '2026-11-15', 'https://gdodig-car.youroperator.it/volantini/iper_BVAIA/BVAIA_01_LOMBARDIA/mobile/BVAIA_01_LOMBARDIA_{n}_sliderzoom.jpg', '2026-09-29'),
 # bennet10 (10-23 settembre), lidl17 e lidlfv17 (17-23 settembre) ed ekom08
 # (8-21 settembre) scaduti e tolti il 2026-09-24: copertura senza buchi
 # passata a bennet1709, lidl24/lidlfv24 ed ekom22.
 _v('mercato17',      'Mercatò',        'dal 17 al 30 settembre',                       'Mercatò — 17-30 settembre.pdf',                    '2026-09-30', None, '2026-09-17', PAGINE_MERCATO_17),
 _v('mercatoreal17', 'Mercatò',        '«Promo L\'Oréal», dal 17 al 30 settembre',     'Mercatò — Promo L\'Oréal 17-30 settembre.pdf',     '2026-09-30', 'https://cdn.dimar.it/volantini/3315/3315_volantino.pdf#page={n}', '2026-09-17'),
 _v('md22',           'MD',             "dal 22 settembre al 4 ottobre",                'MD — 22 settembre-4 ottobre.pdf',                  '2026-10-04', 'https://volantino.mdspa.it/volantino/3557/md-volantino-page-{n}.jpg', '2026-09-22'),
 ...
 _v('bennetextra24',  'Bennet',         '«Offerte Extra», dal 24 settembre al 4 ottobre', 'Bennet — Offerte Extra 24 settembre-4 ottobre.pdf', '2026-10-04', 'https://bennet-cdn.thron.com/static/CR7BHE_PROMO_19-Vege26055-TuttiPdV_149GNT.pdf#page={n}', '2026-09-24'),
 ...
 # Trovato il 2026-09-24: un nuovo speciale Lidl Frutta e Verdura, come
 # lidlfv17 che scade lo stesso giorno. 7 pagine, stesso periodo di lidl24.
...
("Olio d'oliva","Carrefour Iper","carriper15","Dispensa","Olio extravergine di oliva 100% italiano – Desantis","1 litro",1,5.79,23,V,"−49%, prima 11,36. Solo con la tessera SpesAmica Payback."),
 ...
 # p7: padelle, guanciale, panni, Barbie, lavavetri, pantofole, felpa, jeans: nessuna categoria
 # p11: lo strudel di mele (1,19 all'etto) non ha categoria
 # p13: il vitello tonnato Fior di Campagna non ha categoria
 # p14: la bevanda Avena Alpro non ha categoria
 # p15: senza categoria il carpaccio di salmone al naturale Starlaks, la cotoletta vegetale Garden Gourmet; i sughi Biffi solo «−30%»
 # p16: senza peso le capsule Vergnano (32) e il tè verde Twinings; orzo Bimbo e cappuccino Nescafé non sono caffè; moka e macchina non alimentari
 # p18: senza categoria le barrette Nature Valley e le compresse Matt
 # p19: senza categoria Cipster, dado Star, Veggy Good, patatine Eldorada, preparato per pancake, caramelle Sperlari
 # p20: senza categoria i noodles Suzi Wan
 # p22: senza categoria Enervit Hydration, gin Mare, vodka Keglevich, amaretto Vincenzi; Poretti solo «−30%»
 # p24: senza categoria Augustiner (confezione regalo), ketchup Heinz, patatine Salati Preziosi
 # p25: senza categoria bicchieri Bormioli, Rice Crackers, Fonzies, maionese Heinz, senape Maille
 # p26: raccolta bollini dei bicchieri; p27: animali; nessuna categoria
 # p31: coloreria, profuma bucato, Lavafast, pavimenti, spugne, detersivo piatti, spray, ricarica ammorbidente (lavaggi non scritti): nessuna categoria
 # p32-33: mocio, scope, sacchi, grucce, guanti: nessuna categoria
 # p34-35: il resto è igiene non in catalogo; p36-47: auto, pellet, pentole, tessile, elettronica, abbigliamento, casa
 ("Lavatrice","Carrefour Iper","carriper29","Cura casa","Detersivo liquido lavatrice Classico, 3 × 22 lavaggi (66) – Dixan","2,97 litri",66,8.49,1,V,"−50%, prima 16,99."),
 ("Biscotti","Carrefour Iper","carriper29","Colazione","Biscotti classici, vari tipi – Mulino Bianco","700 g",0.7,1.69,1,V,"−50%, prima 3,39. Stesso prezzo per le confezioni da 800 g: qui il conto è sul formato più piccolo."),
 ("Pizza","Carrefour Iper","carriper29","Surgelati","Pizza Margherita Bella Napoli, conf. 3 pezzi – Buitoni","900 g",0.9,3.49,1,V,"−50%, prima 6,99. Surgelata. Solo con la tessera SpesAmica Payback."),
 ("Prosciutto","Carrefour Iper","carriper29","Salumi","Sofficette Prosciutto Cotto Alta Qualità Tripack – Citterio","300 g (3 × 100 g)",0.3,4.99,1,V,"−50%, prima 9,99."),
 ("Preparati","Carrefour Iper","carriper29","Macelleria","Linea hamburger pollo e tacchino – Aia","200 g",0.2,1.99,2,V,"−50%, prima 3,99."),
 ("Mortadella","Carrefour Iper","carriper29","Salumi","Mortadella con o senza pistacchio","al kg",1,8.90,2,V,"−50%, prima 17,90 al kg."),
 ("Suino","Carrefour Iper","carriper29","Macelleria","Coppa di suino a fette senz'osso","al kg",1,5.99,2,V,"−50%, prima 11,99 al kg."),
 ("Formaggio","Carrefour Iper","carriper29","Salumi","Carezza di Latte","al kg",1,6.45,2,V,"−50%, prima 1,29 all'etto."),
 ("Formaggio","Carrefour Iper","carriper29","Salumi","Bel Paese – Galbani","al kg",1,9.90,2,V,"−50%, prima 1,99 all'etto."),
 ("Pasta","Carrefour Iper","carriper29","Freschi","Gnocchi di patate freschi","1 kg",1,2.99,2,V,"−50%, prima 5,99."),
 ("Verdura","Carrefour Iper","carriper29","Ortofrutta","Funghi champignon","1 kg",1,2.99,2,V,"−50%, prima 5,99."),
 ("Formaggio","Carrefour Iper","carriper29","Freschi","GranMix classico grattugiato – Ferrari","200 g",0.2,2.19,3,V,"−50%, prima 4,49. Formaggio grattugiato misto, non Grana né Parmigiano."),
 ("Ricotta","Carrefour Iper","carriper29","Freschi","Gran Ricotta, conf. 3 pezzi – Biraghi","150 g (3 × 50 g)",0.15,0.79,3,V,"−50%, prima 1,59. Solo con la tessera SpesAmica Payback."),
 ("Salmone affumicato","Carrefour Iper","carriper29","Freschi","Salmone norvegese affumicato – The Icelander","150 g",0.15,3.79,3,V,"−50%, prima 8,19."),
 ("Formaggio","Carrefour Iper","carriper29","Freschi","Gorgonzola DOP Dolcelatte – Galbani","150 g",0.15,1.49,3,V,"−50%, prima 2,99. Solo con la tessera SpesAmica Payback."),
 ("Mortadella","Carrefour Iper","carriper29","Salumi","Mortadella Bologna IGP Bipack – Beretta","220 g (2 × 110 g)",0.22,2.99,3,V,"−50%, prima 5,99."),
 ("Verdure surgelate","Carrefour Iper","carriper29","Surgelati","Buon Minestrone – Orogel","750 g",0.75,1.55,3,V,"−50%, prima 3,10. Solo con la tessera SpesAmica Payback."),
 ("Yogurt","Carrefour Iper","carriper29","Freschi","LC1 con probiotico, gusti assortiti, conf. 12 pezzi – Nestlé","1,08 kg",1.08,3.19,4,V,"−50%, prima 6,80. Sono yogurt da bere. Solo con la tessera SpesAmica Payback."),
 ("Yogurt","Carrefour Iper","carriper29","Freschi","Yogurt cremoso, gusti assortiti, conf. 2 pezzi – Müller","250 g (2 × 125 g)",0.25,0.75,4,V,"−50%, prima 1,50."),
 ("Caffè","Carrefour Iper","carriper29","Colazione","Caffè Aroma Italiano, conf. 4 pezzi – Kimbo","1 kg (4 × 250 g)",1,10.49,4,V,"−50%, prima 20,98. Solo con la tessera SpesAmica Payback."),
 ("Latte","Carrefour Iper","carriper29","Freschi","Latte UHT Italiano parzialmente scremato – Granarolo","1 litro",1,0.85,4,V,"−50%, prima 1,71."),
 ("Biscotti","Carrefour Iper","carriper29","Colazione","Biscotti Gran Dispensa, gusti assortiti – Colussi","565 g",0.565,1.89,4,V,"−50%, prima 3,79. Solo con la tessera SpesAmica Payback."),
 ("Cereali","Carrefour Iper","carriper29","Colazione","Special K Classico – Kellogg's","450 g",0.45,1.79,4,V,"−50%, prima 3,59. Solo con la tessera SpesAmica Payback."),
 ("Marmellata","Carrefour Iper","carriper29","Colazione","Composte, gusti assortiti – Zuegg","230 g",0.23,1.59,4,V,"−50%, prima 3,19. Solo con la tessera SpesAmica Payback."),
 ("Verdure surgelate","Carrefour Iper","carriper29","Surgelati","Spinaci, cicoria o bieta Cubello Foglia Più – Orogel","900 g",0.9,1.95,4,V,"−50%, prima 3,90. Solo con la tessera SpesAmica Payback."),
 ("Tonno","Carrefour Iper","carriper29","Dispensa","Filetti di tonno in olio di oliva – Consorcio","295 g",0.295,5.99,5,V,"−50%, prima 11,99. Solo con la tessera SpesAmica Payback."),
 ("Tonno","Carrefour Iper","carriper29","Dispensa","Tonno all'olio d'oliva, conf. 8 pezzi – Mareblu","480 g (8 × 60 g)",0.48,5.49,5,V,"−50%, prima 10,99. Solo con la tessera SpesAmica Payback."),
 ("Pasta","Carrefour Iper","carriper29","Dispensa","Pasta di semola di grano duro, formati assortiti – De Cecco","500 g",0.5,0.75,5,V,"−50%, prima 1,58. Solo con la tessera SpesAmica Payback."),
 ("Legumi","Carrefour Iper","carriper29","Dispensa","Lenticchie – Delverde","240 g",0.24,0.49,5,V,"−50%, prima 0,99. Solo con la tessera SpesAmica Payback."),
 ("Pomodoro","Carrefour Iper","carriper29","Dispensa","Passata di pomodoro Extrafine – Petti","700 g",0.7,0.95,5,V,"−50%, prima 1,99. Solo con la tessera SpesAmica Payback."),
 ("Olio d'oliva","Carrefour Iper","carriper29","Dispensa","Olio extravergine di oliva – Clemente","750 ml",0.75,3.49,5,V,"−50%, prima 6,99. Solo con la tessera SpesAmica Payback."),
 ("Acqua","Carrefour Iper","carriper29","Bevande","Acqua naturale, conf. 6 pezzi – Levissima","12 litri (6 × 2 l)",12,2.99,5,V,"−50%, prima 5,99. Solo con la tessera SpesAmica Payback."),
 ("Bibite","Carrefour Iper","carriper29","Bevande","Thè, gusti assortiti – San Benedetto","1,5 litri",1.5,0.69,5,V,"−50%, prima 1,39. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Original Pils, conf. 3 pezzi – Beck's","990 ml (3 × 330 ml)",0.99,1.89,6,V,"−50%, prima 3,79. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Nastro Azzurro Stile Capri – Peroni","330 ml",0.33,0.69,6,V,"−50%, prima 1,39. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Spumante Cuvée Extra Dry – Porta dei Dogi","750 ml",0.75,2.89,6,V,"−50%, prima 5,78. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Chianti DOCG o Orvieto DOC Poggio al Sale – Piccini","750 ml",0.75,2.99,6,V,"−50%, prima 5,99. Solo con la tessera SpesAmica Payback."),
 ("Bagnoschiuma","Carrefour Iper","carriper29","Cura persona","Bagnodoccia, profumazioni assortite – Spuma di Sciampagna","650 ml",0.65,1.39,6,V,"−50%, prima 2,78. Solo con la tessera SpesAmica Payback."),
 ("Bagnoschiuma","Carrefour Iper","carriper29","Cura persona","Detergente intimo, conf. 2 pezzi – Neutromed","400 ml (2 × 200 ml)",0.4,2.49,6,V,"−50%, prima 4,99. Solo con la tessera SpesAmica Payback."),
 ("Preparati","Carrefour Iper","carriper29","Macelleria","Linea hamburger Skin: vitello, scottona al parmigiano, scottona al bacon o argentino","180 g",0.18,3.89,8,V,"Comprando 3 confezioni o più costa 2,99 al pezzo."),
 ("Vitello","Carrefour Iper","carriper29","Macelleria","Fettine sceltissime di vitello, confezione risparmio","al kg",1,18.99,8,V,"−29%, prima 26,99 al kg."),
 ("Manzo","Carrefour Iper","carriper29","Macelleria","Tagliata di bovino adulto","al kg",1,18.89,8,V,"−30%, prima 26,99 al kg."),
 ("Manzo","Carrefour Iper","carriper29","Macelleria","Polpa per roastbeef di bovino adulto","al kg",1,18.99,8,V,"−20%, prima 23,99 al kg."),
 ("Salsiccia","Carrefour Iper","carriper29","Macelleria","Salsiccia a punta di coltello Carne al Fuoco – Aia","400 g",0.4,3.99,8,V,"−33%, prima 5,99."),
 ("Pollo","Carrefour Iper","carriper29","Macelleria","Petti di pollo a fette, confezione risparmio","al kg",1,9.50,8,V,"−20%, prima 11,99 al kg. Comprando 2 kg o più costa 7,90 al kg."),
 ("Preparati","Carrefour Iper","carriper29","Macelleria","Linea Birbe – Amadori","300 g",0.3,3.49,8,V,"−32%, prima 5,19. Bocconcini di pollo impanati."),
 ("Preparati","Carrefour Iper","carriper29","Macelleria","Linea Alette Durango","400 g",0.4,3.99,8,V,"−33%, prima 5,99. Ali di pollo già insaporite."),
 ("Calamari","Carrefour Iper","carriper29","Pescheria","Totano","al kg",1,9.90,9,V,"−23%, prima 12,90 al kg."),
 ("Pesce","Carrefour Iper","carriper29","Pescheria","Filetto di persico africano","al kg",1,17.90,9,V,""),
 ("Pesce","Carrefour Iper","carriper29","Pescheria","Orata Croazia allevata nel Mar Adriatico, 400/600 g – Cromaris","al kg",1,10.90,9,V,"−39%, prima 17,99 al kg. Comprando 3 kg o più costa 9,90 al kg."),
 ("Gamberi","Carrefour Iper","carriper29","Pescheria","Mazzancolle tropicali cotte grandi","al kg",1,11.90,9,V,"−33%, prima 17,90 al kg. Già cotte. Comprando 2 kg o più costa 9,90 al kg."),
 ("Calamari","Carrefour Iper","carriper29","Pescheria","Anelli di totano decongelati","al kg",1,7.90,9,V,"−38%, prima 12,90 al kg."),
 ("Salmone affumicato","Carrefour Iper","carriper29","Pescheria","Salmone affumicato norvegese","150 g",0.15,4.49,9,V,"−50%, prima 8,98."),
 ("Pesce","Carrefour Iper","carriper29","Pescheria","Vongole lupino","al kg",1,6.90,9,V,"−22%, prima 8,90 al kg."),
 ("Prosciutto","Carrefour Iper","carriper29","Salumi","Prosciutto cotto Gran Biscotto – Rovagnati","al kg",1,23.90,10,V,"−20%, prima 29,90 al kg. Comprando 3 etti o più costa 20,90 al kg."),
 ("Prosciutto","Carrefour Iper","carriper29","Salumi","Prosciutto di Norcia IGP Selezione – Terre d'Italia","al kg",1,29.90,10,V,""),
 ("Affettati","Carrefour Iper","carriper29","Salumi","Arrosto di tacchino","al kg",1,15.90,10,V,"−26%, prima 2,15 all'etto."),
 ("Preparati","Carrefour Iper","carriper29","Gastronomia","Pollo arrosto Campese – Amadori","750 g",0.75,7.90,10,V,"−27%, prima 10,90. Pollo già arrosto, peso minimo garantito 750 g."),
 ("Affettati","Carrefour Iper","carriper29","Salumi","Gran fesa di manzo cotta – Raspini","al kg",1,20.72,10,V,"−20%, prima 2,59 all'etto."),
 ("Formaggio","Carrefour Iper","carriper29","Salumi","Formaggio Piemontino stagionato oltre 16 mesi, confezione famiglia","al kg",1,11.90,10,V,"−20%, prima 1,49 all'etto."),
 ("Formaggio","Carrefour Iper","carriper29","Salumi","Toma Valsesia – Borgoformaggi","al kg",1,13.65,10,V,"−30%, prima 1,95 all'etto."),
 ("Formaggio","Carrefour Iper","carriper29","Salumi","Emmental francese – President","al kg",1,11.90,10,V,"−20%, prima 1,49 all'etto."),
 ("Formaggio","Carrefour Iper","carriper29","Salumi","Gorgonzola DOP – Gim","al kg",1,9.90,10,V,"−33%, prima 1,49 all'etto."),
 ("Pesce","Carrefour Iper","carriper29","Pescheria","Polpo decongelato","al kg",1,18.90,9,V,"−27%, prima 25,90 al kg."),
 ("Verdura","Carrefour Iper","carriper29","Ortofrutta","Pomodori Piccadilly","500 g",0.5,1.99,11,V,""),
 ("Verdura","Carrefour Iper","carriper29","Ortofrutta","Zucchine scure sfuse","al kg",1,1.99,11,V,"−20%, prima 2,49 al kg."),
 ("Frutta","Carrefour Iper","carriper29","Ortofrutta","Fichi d'India sfusi","al kg",1,1.99,11,V,"−30%, prima 2,85 al kg."),
 ("Frutta","Carrefour Iper","carriper29","Ortofrutta","Uva bianca senza semi","500 g",0.5,0.99,11,V,"−50%, prima 1,99. Comprando 4 confezioni o più costa 0,79 l'una."),
 ("Bibite","Carrefour Iper","carriper29","Bevande","Succo di mela – Melinda","1 litro",1,2.99,11,V,"−20%, prima 3,74."),
 ("Frutta","Carrefour Iper","carriper29","Ortofrutta","Mele Gala sfuse","al kg",1,1.39,11,V,"−30%, prima 1,99 al kg."),
 ("Frutta","Carrefour Iper","carriper29","Ortofrutta","Mele Sweettango","750 g",0.75,1.79,11,V,"−20%, prima 2,24."),
 ("Merendine","Carrefour Iper","carriper29","Panetteria","Allegra alle mele","85 g",0.085,0.50,11,V,"−43%, prima 0,89."),
 ("Frutta","Carrefour Iper","carriper29","Ortofrutta","Mele Golden Bio","800 g",0.8,1.89,11,V,"−25%, prima 2,52."),
 ("Pasta","Carrefour Iper","carriper29","Freschi","Cavatelli","500 g",0.5,1.69,12,V,"−22%, prima 2,19."),
 ("Pasta","Carrefour Iper","carriper29","Freschi","Orecchiette fresche","500 g",0.5,1.69,12,V,"−22%, prima 2,19."),
 ("Pasta","Carrefour Iper","carriper29","Freschi","Fusilli al ferretto","500 g",0.5,1.69,12,V,"−22%, prima 2,19."),
 ("Pasta","Carrefour Iper","carriper29","Dispensa","Orecchiette di Puglia – Terre d'Italia","500 g",0.5,2.09,12,V,"−22%, prima 2,69. Solo con la tessera SpesAmica Payback."),
 ("Formaggio","Carrefour Iper","carriper29","Freschi","Burrata Ciuffo d'Amore","125 g",0.125,1.76,12,V,"−20%, prima 2,20. È burrata, non mozzarella. Solo con la tessera SpesAmica Payback."),
 ("Formaggio","Carrefour Iper","carriper29","Salumi","Cacioricotta misto – Gioiella","al kg",1,13.52,12,V,"−20%, prima 1,69 all'etto. Solo con la tessera SpesAmica Payback."),
 ("Pane","Carrefour Iper","carriper29","Panetteria","Pane di semola di grano duro","al kg",1,4.99,12,V,""),
 ("Mozzarella","Carrefour Iper","carriper29","Freschi","Mozzarella di Gioia del Colle DOP – Terre d'Italia","250 g",0.25,3.36,12,V,"−20%, prima 4,20. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Primitivo, Negramaro, Fiano o Negramaro Rosato Salento IGT – Notte Rossa","750 ml",0.75,3.99,12,V,"−29%, prima 5,63. Solo con la tessera SpesAmica Payback."),
 ("Olio d'oliva","Carrefour Iper","carriper29","Dispensa","Olio extravergine di oliva IGP di Puglia – Terre d'Italia","500 ml",0.5,6.79,12,V,"−20%, prima 8,49. Solo con la tessera SpesAmica Payback."),
 ("Formaggio","Carrefour Iper","carriper29","Freschi","Caprice des Dieux","200 g",0.2,2.79,13,V,"−26%, prima 3,79."),
 ("Mozzarella","Carrefour Iper","carriper29","Freschi","Pizzottella – Prealpi","250 g",0.25,1.99,13,V,"−33%, prima 2,99. Mozzarella per pizza."),
 ("Spalmabili","Carrefour Iper","carriper29","Freschi","Robiola, conf. 2 pezzi – Osella","200 g (2 × 100 g)",0.2,1.89,13,V,"−23%, prima 2,46. Solo con la tessera SpesAmica Payback."),
 ("Mozzarella","Carrefour Iper","carriper29","Freschi","Mozzarella di bufala campana DOP, conf. 3 pezzi – Francia","300 g (3 × 100 g)",0.3,2.79,13,V,"−40%, prima 4,66. Solo con la tessera SpesAmica Payback."),
 ("Formaggio","Carrefour Iper","carriper29","Freschi","Stracchino cremoso Alta Qualità – Granarolo","170 g",0.17,1.59,13,V,"−42%, prima 2,75. Solo con la tessera SpesAmica Payback."),
 ("Formaggio","Carrefour Iper","carriper29","Freschi","Leerdammer Special Toast","125 g",0.125,1.65,13,V,"−20%, prima 2,07."),
 ("Formaggio","Carrefour Iper","carriper29","Freschi","Biraghini – Biraghi","200 g",0.2,2.99,13,V,"−33%, prima 4,49."),
 ("Formaggio","Carrefour Iper","carriper29","Freschi","Pecorino grattugiato – Ferrari","60 g",0.06,1.19,13,V,"−20%, prima 1,49. Solo con la tessera SpesAmica Payback."),
 ("Mozzarella","Carrefour Iper","carriper29","Freschi","Mozzarella 100% latte italiano, conf. 3 pezzi – Granarolo","2 × 300 g (1+1)",0.6,4.79,13,V,"È un 1+1: si pagano 4,79 e se ne portano via due. Una confezione sola costa 4,79."),
 ("Prosciutto","Carrefour Iper","carriper29","Salumi","Sticks di speck IGP, conf. 2 pezzi – Handl","70 g (2 × 35 g)",0.07,1.99,13,V,"−35%, prima 3,07. Solo con la tessera SpesAmica Payback."),
 ("Pancetta","Carrefour Iper","carriper29","Salumi","Bacon – Citterio","80 g",0.08,1.99,13,V,"−27%, prima 2,73. Solo con la tessera SpesAmica Payback."),
 ("Prosciutto","Carrefour Iper","carriper29","Salumi","Prosciutto crudo Sofficette – Citterio","80 g",0.08,2.39,13,V,"−31%, prima 3,47. Solo con la tessera SpesAmica Payback."),
 ("Affettati","Carrefour Iper","carriper29","Salumi","Fesa di tacchino arrosto – Amadori","100 g",0.1,1.89,13,V,"−36%, prima 2,96. Solo con la tessera SpesAmica Payback."),
 ("Pasta","Carrefour Iper","carriper29","Freschi","Agnolotti del plin alla carne – Alfieri","250 g",0.25,2.99,13,V,""),
 ("Mozzarella","Carrefour Iper","carriper29","Freschi","Mozzarella Fiordilatte – Centrale del Latte di Torino","100 g",0.1,1.09,13,V,""),
 ("Verdure surgelate","Carrefour Iper","carriper29","Surgelati","Virtù di Zuppa Leggerezza, gusti assortiti – Orogel","500 g",0.5,1.99,14,V,"−35%, prima 3,07. Solo con la tessera SpesAmica Payback."),
 ("Panati","Carrefour Iper","carriper29","Surgelati","15 bastoncini di filetti di merluzzo – Frosta","450 g",0.45,3.89,14,V,"−37%, prima 6,18. Solo con la tessera SpesAmica Payback."),
 ("Verdure surgelate","Carrefour Iper","carriper29","Surgelati","Piselli Tenerezza – Bonduelle","600 g",0.6,1.99,14,V,"−33%, prima 2,98. Solo con la tessera SpesAmica Payback."),
 ("Merendine","Carrefour Iper","carriper29","Surgelati","Nutella Croissant, conf. 4 pezzi","340 g",0.34,2.99,14,V,"−25%, prima 3,99. Surgelati. Solo con la tessera SpesAmica Payback."),
 ("Burro","Carrefour Iper","carriper29","Freschi","Burro – Latteria Soresina","250 g",0.25,2.29,14,V,"−34%, prima 3,49."),
 ("Uova","Carrefour Iper","carriper29","Freschi","Uova fresche da allevamento a terra, conf. 10 pezzi – Le Naturelle","10 uova",10,2.69,14,V,"−29%, prima 3,79."),
 ("Latte","Carrefour Iper","carriper29","Freschi","Latte Zymil 1% parzialmente scremato – Parmalat","1 litro",1,1.59,14,V,"Senza lattosio."),
 ("Yogurt","Carrefour Iper","carriper29","Freschi","Yogurt alla greca bianco – Meraki","1 kg",1,2.99,14,V,""),
 ("Yogurt","Carrefour Iper","carriper29","Freschi","Sveltesse I Love Kefir, gusti assortiti – Nestlé","500 g",0.5,1.29,14,V,"−30%, prima 1,85. È kefir da bere."),
 ("Yogurt","Carrefour Iper","carriper29","Freschi","Yogurt soia Più Frutta, mango o frutti rossi – Alpro","135 g",0.135,0.99,14,V,"−33%, prima 1,49. Di soia."),
 ("Latte","Carrefour Iper","carriper29","Freschi","Latte UHT Alta Digeribilità – Centrale del Latte di Torino","1 litro",1,1.29,14,V,"−35%, prima 1,99. Solo con la tessera SpesAmica Payback."),
 ("Yogurt","Carrefour Iper","carriper29","Freschi","Yogurt intero o magro, bianco o alla frutta, conf. 2 pezzi – Centrale del Latte di Torino","250 g (2 × 125 g)",0.25,0.89,14,V,""),
 ("Burro","Carrefour Iper","carriper29","Freschi","Burro – Centrale del Latte di Torino","125 g",0.125,1.99,14,V,""),
 ("Pasta","Carrefour Iper","carriper29","Freschi","Pasta fresca di semola, formati assortiti – Divella","500 g",0.5,1.29,15,V,"−35%, prima 1,99."),
 ("Pasta","Carrefour Iper","carriper29","Freschi","Lasagne sottili Sfogliavelo – Rana","250 g",0.25,1.69,15,V,"−34%, prima 2,59."),
 ("Pasta","Carrefour Iper","carriper29","Freschi","Pasta ripiena Gran Classici, ripieni assortiti – Fini","400 g",0.4,1.69,15,V,"−39%, prima 2,79. Comprando 4 confezioni o più costa 1,49 l'una."),
 ("Pane","Carrefour Iper","carriper29","Freschi","Pinsa fresca","500 g",0.5,3.19,15,V,"−20%, prima 3,99. È una base tipo focaccia, non pane a fette."),
 ("Sughi","Carrefour Iper","carriper29","Freschi","Pesto fresco con o senza aglio – Il Pesto di Prà","90 g",0.09,2.49,15,V,"−28%, prima 3,49."),
 ("Panati","Carrefour Iper","carriper29","Surgelati","Filetti di merluzzo gratinati, gusti assortiti – Frosta","360 g",0.36,3.49,15,V,"−35%, prima 5,38. Solo con la tessera SpesAmica Payback."),
 ("Sughi","Carrefour Iper","carriper29","Surgelati","Condiscoglio – Arbi","450 g",0.45,3.69,15,V,"−33%, prima 5,51. Sugo di frutti di mare surgelato. Solo con la tessera SpesAmica Payback."),
 ("Verdure surgelate","Carrefour Iper","carriper29","Surgelati","Broccoli Freschi di Campo","1 kg",1,2.89,15,V,"−21%, prima 3,66. Solo con la tessera SpesAmica Payback."),
 ("Merluzzo","Carrefour Iper","carriper29","Surgelati","Filetti di merluzzo atlantico – Brasmar","1 kg",1,6.79,15,V,"−20%, prima 8,49. Surgelati. Solo con la tessera SpesAmica Payback."),
 ("Verdure surgelate","Carrefour Iper","carriper29","Surgelati","Tortini spinaci o ortolano – Frosta","240 g",0.24,1.99,15,V,"−26%, prima 2,69. Tortini di verdure. Solo con la tessera SpesAmica Payback."),
 ("Verdure surgelate","Carrefour Iper","carriper29","Surgelati","Sfizi croccanti, gusti assortiti – Orogel","400 g",0.4,2.69,15,V,"−36%, prima 4,21. Verdure impanate. Solo con la tessera SpesAmica Payback."),
 ("Pizza","Carrefour Iper","carriper29","Surgelati","Pizza Ristorante, gusti assortiti – Cameo","355 g",0.355,1.99,15,V,"−48%, prima 3,84. Surgelata. Solo con la tessera SpesAmica Payback."),
 ("Caffè","Carrefour Iper","carriper29","Colazione","Caffè in grani Qualità Rossa – Lavazza","1 kg",1,18.99,16,V,"−30%. Solo con la tessera SpesAmica Payback."),
 ("Caffè","Carrefour Iper","carriper29","Colazione","Caffè macinato Classico, Morbido, Forte o Espresso – Carrefour Classic","250 g",0.25,2.99,16,V,"−20%, prima 3,74. Solo con la tessera SpesAmica Payback."),
 ("Caffè","Carrefour Iper","carriper29","Colazione","Caffè macinato Soft Can, gusto classico o intenso – Illy","185 g",0.185,4.69,16,V,"−20%, prima 5,87. Solo con la tessera SpesAmica Payback."),
 ("Caffè","Carrefour Iper","carriper29","Colazione","Capsule Dolce Gusto, gusti assortiti, 30 capsule – Kimbo","210 g",0.21,6.39,16,V,"−35%, prima 9,84. Compatibili Nescafé Dolce Gusto. Solo con la tessera SpesAmica Payback."),
 ("Caffè","Carrefour Iper","carriper29","Colazione","Capsule compatibili Nespresso, gusti assortiti – Starbucks","57 g",0.057,3.29,16,V,""),
 ("Caffè","Carrefour Iper","carriper29","Colazione","Caffè in capsule, gusti assortiti, 30 capsule – L'Or","156 g",0.156,7.99,16,V,"−22%, prima 10,25. Solo con la tessera SpesAmica Payback."),
 ("Caffè","Carrefour Iper","carriper29","Colazione","Capsule, gusti assortiti, 16 capsule – Bialetti","115 g",0.115,4.99,16,V,"−20%, prima 6,24. Solo con la tessera SpesAmica Payback."),
 ("Tè","Carrefour Iper","carriper29","Colazione","Camomilla Filtrofiore – Bonomelli","28 g",0.028,3.69,16,V,"−20%, prima 4,62. Solo con la tessera SpesAmica Payback."),
 ("Tè","Carrefour Iper","carriper29","Colazione","Infuso Karkadè – Everton","40 g",0.04,1.99,16,V,"−30%, prima 2,85. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Tavolette Nocciolato, gusti assortiti – Novi","130 g",0.13,3.09,17,V,"−20%, prima 3,87. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Tavolette classiche latte o fondente – Novi","100 g",0.1,1.39,17,V,"−30%, prima 1,99. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Tavolette Variety, gusti assortiti – Ritter Sport","100 g",0.1,1.59,17,V,"−20%, prima 1,99. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Tavoletta Tuc, Oro Ciock o Oreo Sandwich – Milka","87 g",0.087,1.49,17,V,"−25%, prima 1,99. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Tavoletta Tasting Experience, gusti assortiti – Vanini","75 g",0.075,1.99,17,V,"−20%, prima 2,49. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Tavolette Excellence, gusti assortiti – Lindt","100 g",0.1,2.89,17,V,"−20%, prima 3,62. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Tavolette Selection","80 g",0.08,1.59,17,V,"−20%, prima 1,99. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Kit Kat Trio, gusti assortiti – Nestlé","125 g",0.125,1.99,17,V,"−40%, prima 3,33. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Tavolette Nero, gusti assortiti – Perugina","85 g",0.085,2.29,17,V,"−20%, prima 2,87. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Emilia cioccolato fondente extra, fondente 70% o bianco – Zàini","200 g",0.2,2.99,17,V,"−30%, prima 4,28. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Cremini classico – Terre d'Italia","150 g",0.15,2.99,17,V,"−20%, prima 3,74. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Baci Bijou, gusti assortiti – Perugina","200 g",0.2,5.99,17,V,"−30%, prima 8,56. Solo con la tessera SpesAmica Payback."),
 ("Cioccolato","Carrefour Iper","carriper29","Colazione","Ovetti Tripack Juve, Inter o Milan – Dolfin","60 g",0.06,2.99,17,V,"−20%, prima 3,74. Solo con la tessera SpesAmica Payback."),
 ("Caffè","Carrefour Iper","carriper29","Colazione","Capsule in alluminio compatibili Nespresso Napoli, Ristretto o Macinato Fresco, 60 capsule – Kimbo","330 g",0.33,9.99,18,V,"−50%, prima 19,99. Comprando 4 confezioni o più costa 8,99 l'una. Solo con la tessera SpesAmica Payback."),
 ("Merendine","Carrefour Iper","carriper29","Colazione","Merende Rollmilk – Balconi","222 g",0.222,0.79,18,V,"−40%, prima 1,33. Solo con la tessera SpesAmica Payback."),
 ("Merendine","Carrefour Iper","carriper29","Colazione","Cornetti farciti, gusti assortiti – Mulino Bianco","300 g",0.3,1.79,18,V,"−40%, prima 2,99. Solo con la tessera SpesAmica Payback."),
 ("Biscotti","Carrefour Iper","carriper29","Colazione","Cereal-Yo, gusti assortiti – Vitasnella","253 g",0.253,1.19,18,V,"−40%, prima 1,99. Solo con la tessera SpesAmica Payback."),
 ("Merendine","Carrefour Iper","carriper29","Colazione","Pan e Cioc – Kinder","290 g",0.29,2.49,18,V,""),
 ("Merendine","Carrefour Iper","carriper29","Colazione","Crostatine, gusti assortiti – Mulino Bianco","400 g",0.4,1.49,18,V,"−45%, prima 2,72. Solo con la tessera SpesAmica Payback."),
 ("Biscotti","Carrefour Iper","carriper29","Colazione","Savoiardi Vicenzovo – Vicenzi","300 g",0.3,0.99,18,V,"−40%, prima 1,65. Solo con la tessera SpesAmica Payback."),
 ("Biscotti","Carrefour Iper","carriper29","Colazione","Frollini Fibraextra – Misura","380 g",0.38,1.69,18,V,"−45%, prima 3,08. Solo con la tessera SpesAmica Payback."),
 ("Cereali","Carrefour Iper","carriper29","Colazione","Cereali Vitalis, gusti assortiti – Cameo","310 g",0.31,1.99,18,V,"−40%, prima 3,32. Solo con la tessera SpesAmica Payback."),
 ("Caffè","Carrefour Iper","carriper29","Colazione","Cialde Crema e Gusto, 100 cialde – Lavazza","700 g",0.7,15.99,18,V,"−20%, prima 19,99. Solo con la tessera SpesAmica Payback."),
 ("Creme","Carrefour Iper","carriper29","Colazione","Nutella","750 g",0.75,5.99,18,V,""),
 ("Marmellata","Carrefour Iper","carriper29","Colazione","Confettura Natù Bio, frutti di bosco, albicocche, mirtilli o fragole – Rigoni di Asiago","240 g",0.24,2.19,18,V,"−24%, prima 2,89. Solo con la tessera SpesAmica Payback."),
 ("Pane","Carrefour Iper","carriper29","Colazione","Fette biscottate dorate o integrali, conf. 2 pezzi – Mulino Bianco","1,26 kg (2 × 630 g)",1.26,3.49,18,V,"−20%, prima 4,37. Sono fette biscottate. Solo con la tessera SpesAmica Payback."),
 ("Biscotti","Carrefour Iper","carriper29","Colazione","Pavesini","200 g",0.2,1.49,18,V,"−40%, prima 2,49. Solo con la tessera SpesAmica Payback."),
 ("Tè","Carrefour Iper","carriper29","Colazione","Le Tisane, gusti assortiti – Pompadour","39 g",0.039,1.99,18,V,"−32%, prima 2,94. Solo con la tessera SpesAmica Payback."),
 ("Riso","Carrefour Iper","carriper29","Dispensa","Riso per risotti Chicchi Grossi – Scotti","1 kg",1,2.79,19,V,"−30%, prima 3,99. Solo con la tessera SpesAmica Payback."),
 ("Pane","Carrefour Iper","carriper29","Dispensa","Cracker Fiori d'Acqua classici o integrali – Mulino Bianco","250 g",0.25,1.39,19,V,"−20%, prima 1,74. Solo con la tessera SpesAmica Payback."),
 ("Olio d'oliva","Carrefour Iper","carriper29","Dispensa","Olio extravergine di oliva italiano Masserie del Parco – Clemente","1 litro",1,5.39,19,V,"−55%, prima 11,99. Comprando 3 bottiglie o più costa 4,99 l'una. Solo con la tessera SpesAmica Payback."),
 ("Olio d'oliva","Carrefour Iper","carriper29","Dispensa","Olio extravergine di oliva – Ascheri","750 ml",0.75,7.49,19,V,"−42%, prima 12,92. Solo con la tessera SpesAmica Payback."),
 ("Pane","Carrefour Iper","carriper29","Panetteria","Pan Bauletto 5 cereali e soia – Mulino Bianco","400 g",0.4,0.99,19,V,"−36%, prima 1,55. Solo con la tessera SpesAmica Payback."),
 ("Farina","Carrefour Iper","carriper29","Dispensa","Farina Universale senza glutine – Dr. Schär","1 kg",1,3.19,19,V,"−22%, prima 4,10. Senza glutine. Solo con la tessera SpesAmica Payback."),
 ("Biscotti","Carrefour Iper","carriper29","Colazione","Biscotto – Plasmon","1,8 kg",1.8,9.90,19,V,"−31%, prima 14,36. Biscotti per bambini. Solo con la tessera SpesAmica Payback."),
 ("Pane","Carrefour Iper","carriper29","Panetteria","Grissini stirati a mano classici o senza strutto – Panificio Bo","350 g",0.35,3.00,19,V,"−20%, prima 3,75. Solo con la tessera SpesAmica Payback."),
 ("Tè","Carrefour Iper","carriper29","Colazione","Infusi, gusti assortiti – Lipton","34 g",0.034,1.99,19,V,"−23%, prima 2,59. Solo con la tessera SpesAmica Payback."),
 ("Pasta","Carrefour Iper","carriper29","Dispensa","Pasta, formati assortiti – Pezzullo","500 g",0.5,0.59,20,V,"−57%, prima 1,39. Comprando 6 pacchi o più costa 0,49 l'uno. Solo con la tessera SpesAmica Payback."),
 ("Pomodoro","Carrefour Iper","carriper29","Dispensa","Polpa di pomodoro, conf. 3 pezzi – Pezzullo","1,2 kg (3 × 400 g)",1.2,1.99,20,V,"−23%, prima 2,59. Solo con la tessera SpesAmica Payback."),
 ("Sughi","Carrefour Iper","carriper29","Dispensa","Gran Pesto alla Genovese, gusti assortiti – Tigullio","190 g",0.19,1.89,20,V,"−27%, prima 2,59. Solo con la tessera SpesAmica Payback."),
 ("Pasta","Carrefour Iper","carriper29","Dispensa","Pasta integrale, formati assortiti – Barilla","500 g",0.5,0.85,20,V,"−32%, prima 1,25. Solo con la tessera SpesAmica Payback."),
 ("Tonno","Carrefour Iper","carriper29","Dispensa","Filetti di tonno, gusti assortiti – Rio Mare","180 g",0.18,4.29,20,V,"−31%, prima 6,23. Solo con la tessera SpesAmica Payback."),
 ("Olio d'oliva","Carrefour Iper","carriper29","Dispensa","Olio di oliva – Bertolli","1 litro",1,5.49,20,V,"−30%, prima 7,85. È olio di oliva, non extravergine. Solo con la tessera SpesAmica Payback."),
 ("Olio di semi","Carrefour Iper","carriper29","Dispensa","Olio di semi di girasole Frienn – Olitalia","1 litro",1,2.15,20,V,"−28%, prima 2,99. Solo con la tessera SpesAmica Payback."),
 ("Olio d'oliva","Carrefour Iper","carriper29","Dispensa","Olio extravergine di oliva – Farchioni","1 litro",1,4.95,20,V,"−46%, prima 9,18. Solo con la tessera SpesAmica Payback."),
 ("Pasta","Carrefour Iper","carriper29","Dispensa","Pasta di legumi Bio senza glutine, lenticchie rosse, ceci o piselli – Felicia","250 g",0.25,1.99,20,V,"−33%, prima 2,98. Solo con la tessera SpesAmica Payback."),
 ("Conserve","Carrefour Iper","carriper29","Dispensa","Olive verdi Olivolì intere o snocciolate – Saclà","120 g",0.12,1.45,20,V,"−30%, prima 2,08. Solo con la tessera SpesAmica Payback."),
 ("Sughi","Carrefour Iper","carriper29","Dispensa","Sughi Ricchi, gusti assortiti – Barilla","300 g",0.3,1.75,20,V,"−35%, prima 2,70. Solo con la tessera SpesAmica Payback."),
 ("Tonno","Carrefour Iper","carriper29","Dispensa","Tonno all'olio di oliva, conf. 9 pezzi – Rio Mare","720 g (9 × 80 g)",0.72,9.45,20,V,"−36%, prima 14,78. Solo con la tessera SpesAmica Payback."),
 ("Conserve","Carrefour Iper","carriper29","Dispensa","Filetti di alici in olio di oliva – Delicius","58 g",0.058,2.49,20,V,"−28%, prima 3,47. Solo con la tessera SpesAmica Payback."),
 ("Conserve","Carrefour Iper","carriper29","Dispensa","Verdure e tonno – Galfrè Ghiotto","160 g",0.16,3.49,20,V,""),
 ("Bibite","Carrefour Iper","carriper29","Bevande","Original o Zero, conf. 2 pezzi – Coca-Cola","3 litri (2 × 1,5 l)",3,2.79,21,V,"−35%, prima 4,36. Solo con la tessera SpesAmica Payback."),
 ("Bibite","Carrefour Iper","carriper29","Bevande","Succhi di frutta Skipper, gusti assortiti – Zuegg","1 litro",1,1.29,21,V,"−35%, prima 1,99. Solo con la tessera SpesAmica Payback."),
 ("Acqua","Carrefour Iper","carriper29","Bevande","Acqua Brio Blu, Brio Rossa o Rocchetta, conf. 6 pezzi","9 litri (6 × 1,5 l)",9,2.59,21,V,"−28%, prima 3,60. Solo con la tessera SpesAmica Payback."),
 ("Bibite","Carrefour Iper","carriper29","Bevande","Energy drink, conf. 8 pezzi – Red Bull","2 litri (8 × 250 ml)",2,7.49,21,V,"−33%, prima 11,18. Comprando 2 confezioni o più costa 6,99 l'una. Solo con la tessera SpesAmica Payback."),
 ("Acqua","Carrefour Iper","carriper29","Bevande","Acqua naturale, conf. 6 pezzi – Panna","9 litri (6 × 1,5 l)",9,2.29,21,V,"−35%, prima 3,77. Solo con la tessera SpesAmica Payback."),
 ("Acqua","Carrefour Iper","carriper29","Bevande","Acqua effervescente naturale, conf. 6 pezzi – Ferrarelle","3 litri (6 × 500 ml)",3,1.69,21,V,""),
 ("Bibite","Carrefour Iper","carriper29","Bevande","Cedrata, gusti assortiti, conf. 4 pezzi – Tassoni","720 ml (4 × 180 ml)",0.72,3.19,21,V,"−20%, prima 3,99. Solo con la tessera SpesAmica Payback."),
 ("Riso","Carrefour Iper","carriper29","Dispensa","Risotti in busta, gusti assortiti – Knorr","175 g",0.175,1.29,21,V,"−26%, prima 1,75. È un risotto pronto da cuocere, non riso semplice. Solo con la tessera SpesAmica Payback."),
 ("Pane","Carrefour Iper","carriper29","Panetteria","Nuvolatte – Morato","400 g",0.4,1.49,21,V,"−28%, prima 2,08. Pane in cassetta. Solo con la tessera SpesAmica Payback."),
 ("Pane","Carrefour Iper","carriper29","Dispensa","Cracker Gran Pavesi salati o non salati – Pavesi","560 g",0.56,1.79,21,V,"−25%, prima 2,39. Solo con la tessera SpesAmica Payback."),
 ("Pane","Carrefour Iper","carriper29","Dispensa","Tuc Bake Rolls Pizza","150 g",0.15,1.29,21,V,"−27%, prima 1,78. Crostini croccanti. Solo con la tessera SpesAmica Payback."),
 ("Conserve","Carrefour Iper","carriper29","Dispensa","Peperlizia, gusti assortiti – Ponti","170 g",0.17,1.99,21,V,"−40%, prima 3,33. Peperoni in agrodolce. Solo con la tessera SpesAmica Payback."),
 ("Acqua","Carrefour Iper","carriper29","Bevande","Acqua naturale o frizzante, conf. 6 pezzi – Eva","9 litri (6 × 1,5 l)",9,1.79,21,V,"−31%, prima 2,60. Solo con la tessera SpesAmica Payback."),
 ("Acqua","Carrefour Iper","carriper29","Bevande","Acqua naturale o frizzante, conf. 12 pezzi – Valmora","6 litri (12 × 500 ml)",6,2.15,21,V,"−35%, prima 3,36. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra lager o dark – Kozel","500 ml",0.5,0.99,22,V,"−36%, prima 1,55. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Nastro Azzurro in lattina – Peroni","500 ml",0.5,0.89,22,V,"−34%, prima 1,35. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra – Heineken","660 ml",0.66,0.99,22,V,"−33%, prima 1,49. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra – Corona","330 ml",0.33,1.09,22,V,""),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra, conf. 12 pezzi – Peroni","3,96 litri (12 × 330 ml)",3.96,7.99,22,V,"−20%, prima 9,99. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Super Strong Lager Scozzese doppio malto – Tennent's","355 ml",0.355,1.49,22,V,""),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra non filtrata, conf. 3 pezzi – Ichnusa","990 ml (3 × 330 ml)",0.99,2.99,22,V,"−30%, prima 4,28. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Strong Ale, conf. 4 pezzi – Ceres","1,32 litri (4 × 330 ml)",1.32,4.99,22,V,"−35%, prima 7,69. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra in lattina – La Chouffe","500 ml",0.5,2.49,22,V,"−24%, prima 3,28. Solo con la tessera SpesAmica Payback."),
 ("Bibite","Carrefour Iper","carriper29","Bevande","Thè, gusti assortiti, conf. 6 pezzi – Carrefour Classic","1,2 litri (6 × 200 ml)",1.2,1.35,22,V,""),
 ("Bibite","Carrefour Iper","carriper29","Bevande","Fruitz!, gusti assortiti, conf. 2 pezzi – Santal","400 ml (2 × 200 ml)",0.4,1.99,22,V,"−23%, prima 2,59. Analcolico alla frutta. Solo con la tessera SpesAmica Payback."),
 ("Bibite","Carrefour Iper","carriper29","Bevande","Fuze Tea, gusti assortiti","400 ml",0.4,0.69,22,V,"−25%, prima 0,93. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Conegliano Valdobbiadene Prosecco Superiore DOCG Extra Dry – Signoria dei Dogi","750 ml",0.75,5.49,23,V,"−36%, prima 8,59. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Rosso Memoro – Piccini","750 ml",0.75,4.89,23,V,"−41%, prima 8,30. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Linea vini – La Calenzana","750 ml",0.75,2.99,23,V,"−50%, prima 5,98. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Chardonnay, Sauvignon o Pinot Grigio Rosato frizzante – Casa Sant'Orsola","750 ml",0.75,2.69,23,V,"−32%, prima 3,97. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Prosecco DOC Extra Dry – Malpasso","750 ml",0.75,3.49,23,V,"−51%, prima 7,13. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Bianco o Rosso o Rosato Verona IGT Fira – Sartori","750 ml",0.75,3.79,23,V,"−46%, prima 7,02. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Est! Est!! Est!!! di Montefiascone DOC o Veritas Est Umbria IGP – Bigi","750 ml",0.75,2.99,23,V,"−40%, prima 4,99. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Montepulciano d'Abruzzo Riserva o Pecorino Superiore DOC Val di Fara – Spinelli","750 ml",0.75,3.19,23,V,"−45%, prima 5,80. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Bonarda o Barbera o Bonarda Amabile Oltrepò Pavese DOC Le Cascine – Losito e Guarini","750 ml",0.75,2.49,23,V,"−45%, prima 4,54. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Barbaresco DOCG Arpatin – Terre d'Italia","750 ml",0.75,15.50,23,V,""),
 ("Vino","Carrefour Iper","carriper29","Bevande","Erbaluce di Caluso DOCG – Cooperativa Produttori di Caluso","750 ml",0.75,5.49,23,V,"−27%, prima 7,53. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Langhe Arneis DOC – Bosio","750 ml",0.75,4.99,23,V,""),
 ("Vino","Carrefour Iper","carriper29","Bevande","Moscato d'Asti DOCG – Canti","750 ml",0.75,4.49,23,V,"−45%, prima 8,17. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Dolcetto d'Alba DOC – Duchessa Lia","750 ml",0.75,4.79,23,V,"−28%, prima 6,66. Solo con la tessera SpesAmica Payback."),
 ("Vino","Carrefour Iper","carriper29","Bevande","Spumante 958 Blu Dolce – Santero","750 ml",0.75,4.49,23,V,""),
 ("Vino","Carrefour Iper","carriper29","Bevande","Barbera d'Asti DOCG I Filari del Poeta","750 ml",0.75,3.49,23,V,"−20%, prima 4,37. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Oktoberfest – Hb","500 ml",0.5,1.99,24,V,""),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Oktoberfest – Löwenbräu","500 ml",0.5,1.29,24,V,""),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Festweisse – Schneider","500 ml",0.5,2.39,24,V,"−20%, prima 2,99. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra – Warsteiner","660 ml",0.66,1.29,24,V,"−31%, prima 1,88. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra 5,0 Original Craft","500 ml",0.5,0.99,24,V,""),
 ("Formaggio","Carrefour Iper","carriper29","Salumi","Brie – Entremont","al kg",1,12.90,24,V,"−23%, prima 1,69 all'etto."),
 ("Formaggio","Carrefour Iper","carriper29","Salumi","Formaggio Margot alla birra","al kg",1,15.90,24,V,"−23%, prima 2,09 all'etto."),
 ("Pane","Carrefour Iper","carriper29","Panetteria","Pane per hot dog, conf. 6 pezzi","330 g",0.33,2.39,24,V,"−20%, prima 2,99. Comprando 2 confezioni o più costa 1,89 l'una."),
 ("Pane","Carrefour Iper","carriper29","Panetteria","Panino per hot dog o hamburger – Carrefour Classic","250 g",0.25,0.79,24,V,"−20%, prima 0,99. Solo con la tessera SpesAmica Payback."),
 ("Würstel","Carrefour Iper","carriper29","Salumi","N.38 Würstel Servelade","240 g",0.24,2.99,24,V,"−28%, prima 4,16. Solo con la tessera SpesAmica Payback."),
 ("Patate","Carrefour Iper","carriper29","Surgelati","Barchette PataSnella – Pizzoli","600 g",0.6,1.79,24,V,"−37%, prima 2,85. Sono patate surgelate da forno, non patate fresche. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Brauhaus Helles Bio – Riedenburger","500 ml",0.5,1.99,25,V,""),
 ("Birra","Carrefour Iper","carriper29","Bevande","Fustino birra Pils – Bitburger","5 litri",5,11.90,25,V,""),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Münchner Weisse – Hofbräu München","500 ml",0.5,1.39,25,V,"−20%, prima 1,74. Solo con la tessera SpesAmica Payback."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Lagerbier Hell – Augustinerbräu München","500 ml",0.5,2.29,25,V,""),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Fresh 0.0 – Warsteiner","330 ml",0.33,0.85,25,V,"Analcolica."),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Black, Helles o Weiss in lattina – Oettinger","500 ml",0.5,0.79,25,V,""),
 ("Birra","Carrefour Iper","carriper29","Bevande","Birra Pils in lattina – Oettinger","500 ml",0.5,0.79,25,V,""),
 ("Preparati","Carrefour Iper","carriper29","Macelleria","Stinco di suino lenta cottura – Aia","650 g",0.65,7.29,25,V,"−30%, prima 10,49. Già cotto."),
 ("Prosciutto","Carrefour Iper","carriper29","Salumi","Trancio di speck Alto Adige IGP – Moser","400 g",0.4,6.24,25,V,"−20%, prima 7,80. Solo con la tessera SpesAmica Payback."),
 ("Würstel","Carrefour Iper","carriper29","Salumi","Wudy Classico, conf. 4 pezzi – Aia","500 g (4 × 125 g)",0.5,2.89,25,V,"−21%, prima 3,67. Solo con la tessera SpesAmica Payback."),
 ("Lavatrice","Carrefour Iper","carriper29","Cura casa","Detersivo liquido Marsiglia o Muschio Bianco, conf. 3 pezzi, 138 lavaggi – Chanteclair","6,21 litri",138,8.99,28,V,"−55%, prima 19,98. Solo con la tessera SpesAmica Payback."),
 ("Ammorbidente","Carrefour Iper","carriper29","Cura casa","Ammorbidente concentrato, 38 lavaggi – Lenor","695 ml",38,2.99,28,V,"−25%, prima 3,99. Solo con la tessera SpesAmica Payback."),
 ("Lavatrice","Carrefour Iper","carriper29","Cura casa","Detersivo liquido, 44 lavaggi – Omino Bianco","1,76 litri",44,3.99,28,V,"−38%, prima 6,44. Solo con la tessera SpesAmica Payback."),
 ("Lavatrice","Carrefour Iper","carriper29","Cura casa","Detersivo Pods, 38 capsule – Dash","38 capsule",38,13.99,28,V,"−28%, prima 19,44. Stesso prezzo per la confezione da 50: qui il conto è sulla più piccola."),
 ("Ammorbidente","Carrefour Iper","carriper29","Cura casa","Ammorbidente concentrato, 87 lavaggi – Coccolino","1,827 litri",87,3.99,28,V,"−45%, prima 7,27. Solo con la tessera SpesAmica Payback."),
 ("Lavatrice","Carrefour Iper","carriper29","Cura casa","Detersivo in polvere Classico, 112 lavaggi – Dixan","6,16 kg",112,15.99,28,V,"−34%, prima 24,23."),
 ("Lavastoviglie","Carrefour Iper","carriper29","Cura casa","Caps lavastoviglie Platinum – Fairy","32 caps",32,7.99,29,V,"−45%, prima 14,53. Stesso prezzo per le confezioni da 40, 45 o 49: qui il conto è sulla più piccola. Comprando 4 confezioni o più costa 6,99 l'una."),
 ("Lavastoviglie","Carrefour Iper","carriper29","Cura casa","Gel lavastoviglie, 30 lavaggi – Finish","30 lavaggi",30,4.29,29,V,"−22%, prima 5,50. Solo con la tessera SpesAmica Payback."),
 ("Lavastoviglie","Carrefour Iper","carriper29","Cura casa","Tabs lavastoviglie, conf. 24 pezzi – Winni's","24 tabs",24,4.49,29,V,"−21%, prima 5,69. Solo con la tessera SpesAmica Payback."),
 ("Asciugatutto","Carrefour Iper","carriper29","Cura casa","Carta casa – Regina di Cuori","6 rotoli",6,3.99,29,V,"−41%, prima 6,79."),
 ("Asciugatutto","Carrefour Iper","carriper29","Cura casa","Bobina Jumbo Roll 500 strappi – Carrefour Essential","1 rotolo",1,3.99,29,V,"−27%, prima 5,49."),
 ("Lavatrice","Carrefour Iper","carriper29","Cura casa","Detersivo lavatrice Marsiglia, 36 lavaggi – Spuma di Sciampagna","1,62 litri",36,2.49,30,V,"−50%, prima 4,98."),
 ("Lavastoviglie","Carrefour Iper","carriper29","Cura casa","Gel lavastoviglie, conf. 3 pezzi, 84 lavaggi – Fairy","504 ml",84,9.99,30,V,"−28%, prima 13,88."),
 ("Lavatrice","Carrefour Iper","carriper29","Cura casa","Detersivo Power Caps, conf. 18 pezzi – Bio Presto","18 capsule",18,3.99,30,V,"−45%, prima 7,27."),
 ("Asciugatutto","Carrefour Iper","carriper29","Cura casa","Asciugatutto Fashion – Nicky","3 rotoli",3,2.19,30,V,"−26%, prima 2,99."),
 ("Ammorbidente","Carrefour Iper","carriper29","Cura casa","Ammorbidente diluito, 45 lavaggi – Vernel","2,97 litri",45,3.39,31,V,"−39%, prima 5,57."),
 ("Lavatrice","Carrefour Iper","carriper29","Cura casa","Detersivo liquido, 41 lavaggi – Sole","1,845 litri",41,4.49,31,V,"−31%, prima 6,52."),
 ("Lavatrice","Carrefour Iper","carriper29","Cura casa","Liquido lavatrice, conf. 3 pezzi da 36 lavaggi (108) – General","4,32 litri (3 × 1,44 l)",108,6.49,31,V,"−53%, prima 13,82."),
 ("Lavastoviglie","Carrefour Iper","carriper29","Cura casa","Tabs All in One, 40 tabs – Actiff","420 g",40,2.99,31,V,"−31%, prima 4,34."),
 ("Lavatrice","Carrefour Iper","carriper29","Cura casa","Detersivo liquido Cicli Brevi, 37 lavaggi – Coccolino","1,48 litri",37,5.99,31,V,"−36%, prima 9,37."),
 ("Bagnoschiuma","Carrefour Iper","carriper29","Cura persona","Docciaschiuma, assortiti – Tesori d'Oriente","500 ml",0.5,2.99,34,V,"−30%, prima 4,28. Solo con la tessera SpesAmica Payback."),
 ("Bagnoschiuma","Carrefour Iper","carriper29","Cura persona","Sapone liquido, profumazioni assortite – Malizia","300 ml",0.3,0.99,34,V,"−33%, prima 1,49. Solo con la tessera SpesAmica Payback."),
 ("Bagnoschiuma","Carrefour Iper","carriper29","Cura persona","Sapone liquido mani, assortiti – Amuchina","250 ml",0.25,1.79,34,V,"−35%, prima 2,76. Solo con la tessera SpesAmica Payback."),
 ("Carta igienica","Carrefour Iper","carriper29","Cura casa","Carta igienica Rotoloni – Regina","12 rotoli",12,7.99,34,V,"−33%, prima 11,99."),
 ("Bagnoschiuma","Carrefour Iper","carriper29","Cura persona","Bagnodoccia, profumazioni assortite – Neutromed","600 ml",0.6,1.89,35,V,"−47%, prima 3,57. Solo con la tessera SpesAmica Payback."),
 ("Collutorio","Carrefour Iper","carriper29","Cura persona","Collutorio, assortiti – Pasta del Capitano","400 ml",0.4,1.29,35,V,"−39%, prima 2,13. Solo con la tessera SpesAmica Payback."),
 ("Dentifricio","Carrefour Iper","carriper29","Cura persona","Dentifricio Complete Protezione e Antibatterico – Oral-B","2 × 75 ml (1+1)",0.15,1.99,35,V,"È un 1+1: si pagano 1,99 e se ne portano via due. Uno solo costa 1,99."),
 ("Bagnoschiuma","Carrefour Iper","carriper29","Cura persona","Ricarica sapone mani, assortite – Jacklon","1 litro",1,1.29,35,V,"−35%, prima 1,99. Solo con la tessera SpesAmica Payback."),
 ("Shampoo","Carrefour Iper","carriper29","Cura persona","Shampoo o balsamo, assortiti – Sunsilk","400 ml",0.4,3.25,35,V,"−32%, prima 4,78. Solo con la tessera SpesAmica Payback."),
 ("Bagnoschiuma","Carrefour Iper","carriper29","Cura persona","Bagnodoccia, profumazioni assortite – Lycia","750 ml",0.75,1.89,35,V,"−32%, prima 2,79. Solo con la tessera SpesAmica Payback."),
 ("Tonno","Carrefour Iper","carriper29","Pescheria","Trancio di tonno pinne gialle decongelato","al kg",1,17.90,48,V,"−30%, prima 25,90 al kg. Vale solo dall'1 al 4 ottobre.","2026-10-01","2026-10-04"),
 ("Tonno","Carrefour Iper","carriper29","Dispensa","Tonno Il Delicato all'olio di semi di girasole, conf. 6 pezzi – MareAperto","420 g (6 × 70 g)",0.42,3.79,48,V,"−45%, prima 6,90. È all'olio di semi, non d'oliva. Vale solo dall'1 al 4 ottobre.","2026-10-01","2026-10-04"),
 ("Pane","Carrefour Iper","carriper29","Panetteria","Piadina Romagnola IGP Riminese – Alimenta","600 g",0.6,1.99,48,V,"−33%, prima 2,99. Vale solo dall'1 al 4 ottobre.","2026-10-01","2026-10-04"),
 ("Vino","Carrefour Iper","carriper29","Bevande","Barbera Piemonte DOC Il Poggio dei Vigneti","750 ml",0.75,1.99,48,V,"−60%, prima 4,99. Vale solo dall'8 all'11 ottobre.","2026-10-08","2026-10-11"),
 ("Pollo","Carrefour Iper","carriper29","Macelleria","Fusi o sovracosce di pollo, confezione risparmio","al kg",1,4.49,48,V,"−35%, prima 6,99 al kg. Vale solo dall'8 all'11 ottobre.","2026-10-08","2026-10-11"),
 ("Pasta","Carrefour Iper","carriper29","Freschi","Casoncelli alla carne","1 kg",1,7.90,48,V,"−20%, prima 9,90. Vale solo dall'8 all'11 ottobre.","2026-10-08","2026-10-11"),
 # ----- Carrefour Iper «Speciale Coca-Cola», 15 settembre-12 ottobre: prezzi senza sconto; pagina 1 è il concorso (carrcoca15), letto per intero il 2026-09-25 -----
 ("Bibite","Carrefour Iper","carrcoca15","Bevande","Fanta o Sprite, gusti assortiti","1,5 litri",1.5,1.59,2,V,""),
 ("Bibite","Carrefour Iper","carrcoca15","Bevande","Tonic Water o Lemon Taste – Kinley","1 litro",1,0.99,2,V,""),
 ("Bibite","Carrefour Iper","carrcoca15","Bevande","Fuze Tea, gusti assortiti","1,25 litri",1.25,1.39,2,V,""),
 ("Bibite","Carrefour Iper","carrcoca15","Bevande","Powerade, gusti assortiti","500 ml",0.5,0.99,2,V,""),
 ("Bibite","Carrefour Iper","carrcoca15","Bevande","Monster Energy, gusti assortiti","500 ml",0.5,1.29,2,V,""),
 ("Bibite","Carrefour Iper","carrcoca15","Bevande","Regular o Zero Zuccheri – Coca-Cola","2 litri",2,2.29,2,V,""),
 # ----- Carrefour Iper «Speciale Unilever», 29 settembre-22 ottobre: gelati (carrunilever29), letto per intero il 2026-09-25 -----
 ("Gelato","Carrefour Iper","carrunilever29","Surgelati","Magnum Signature, gusti assortiti, conf. 3 pezzi – Algida","208,5 g",0.2085,3.99,1,V,""),
 ("Gelato","Carrefour Iper","carrunilever29","Surgelati","Magnum, gusti assortiti, conf. 4 pezzi – Algida","300 g",0.3,3.99,1,V,""),
 ("Gelato","Carrefour Iper","carrunilever29","Surgelati","Magnum Bomboniera, gusti assortiti, conf. 12 pezzi – Algida","104 g",0.104,2.99,1,V,""),
 ("Gelato","Carrefour Iper","carrunilever29","Surgelati","Cornetto, gusti assortiti, conf. 6 pezzi – Algida","450 g",0.45,4.49,1,V,""),
 ("Gelato","Carrefour Iper","carrunilever29","Surgelati","Cornetto Max, gusti assortiti, conf. 6 pezzi – Algida","390 g",0.39,4.49,1,V,""),
 ("Gelato","Carrefour Iper","carrunilever29","Surgelati","Affogato, gusti assortiti – Carte d'Or","500 g",0.5,3.49,2,V,""),
 ("Gelato","Carrefour Iper","carrunilever29","Surgelati","Viennetta – Algida","650 g",0.65,3.19,2,V,""),
 ("Gelato","Carrefour Iper","carrunilever29","Surgelati","Cucciolone, conf. 6 pezzi – Algida","480 g",0.48,4.39,2,V,""),
 ("Gelato","Carrefour Iper","carrunilever29","Surgelati","Gelato, gusti assortiti – Ben & Jerry's","465 g",0.465,4.49,2,V,""),
 # ----- Carrefour Iper «Speciale Aia», 29 settembre-15 novembre: pagina 1 fino al 22 ottobre, pagina 2 dal 23 ottobre; il BonRoll è su tutte e due (carraia29), letto per intero il 2026-09-25 -----
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Polpettine di suino – Aia","320 g",0.32,3.99,1,V,"−31%, prima 5,79. Vale dal 29 settembre al 22 ottobre.","2026-09-29","2026-10-22"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Alette di pollo arrosto Durango Extra Hot, con erbe aromatiche o Original – Aia","400 g",0.4,3.99,1,V,"−33%, prima 5,99. Già cotte. Vale dal 29 settembre al 22 ottobre.","2026-09-29","2026-10-22"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","BonRoll Classico, ripieno con spinaci o con speck – Aia","680 g",0.68,6.49,1,V,"−44%, prima 11,59."),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","BonRoll Easy con spinaci o con prosciutto e formaggio – Aia","300 g",0.3,3.99,1,V,"−33%, prima 5,99. Vale dal 29 settembre al 22 ottobre.","2026-09-29","2026-10-22"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Hamburger classico di tacchino con rosmarino o di pollo – Aia","200 g",0.2,1.99,1,V,"−50%, prima 3,99. Vale dal 29 settembre al 22 ottobre.","2026-09-29","2026-10-22"),
 ("Pollo","Carrefour Iper","carraia29","Macelleria","Sottilissime, fettine di filetti di pollo – Aia","al kg",1,12.49,1,V,"−30%, prima 17,92 al kg. Vale dal 29 settembre al 22 ottobre.","2026-09-29","2026-10-22"),
 ("Pollo","Carrefour Iper","carraia29","Macelleria","Quarti di pollo – Aia","al kg",1,4.73,1,V,"−25%, prima 6,31 al kg. Vale dal 29 settembre al 22 ottobre.","2026-09-29","2026-10-22"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Sottilissime, cotolette di filetti di pollo impanate – Aia","140 g",0.14,1.99,1,V,"−33%, prima 2,99. Vale dal 29 settembre al 22 ottobre.","2026-09-29","2026-10-22"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Cotolette impanate La Milanese o Spinacine Grancroccanti – Aia","300 g",0.3,3.59,1,V,"−40%, prima 5,99. Vale dal 29 settembre al 22 ottobre.","2026-09-29","2026-10-22"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Bigger, cotolette di pollo con limoni di Sicilia – Aia","280 g",0.28,3.59,1,V,"−40%, prima 5,99. Vale dal 29 settembre al 22 ottobre.","2026-09-29","2026-10-22"),
 ("Würstel","Carrefour Iper","carraia29","Salumi","Wudy Crunchy Pops, 20 mini würstel panati – Aia","280 g",0.28,1.99,2,V,"−39%, prima 3,29. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ("Salsiccia","Carrefour Iper","carraia29","Macelleria","Negronetta, salsiccia fresca luganega di suino – Negroni","300 g",0.3,3.99,2,V,"−27%, prima 5,49. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ("Salsiccia","Carrefour Iper","carraia29","Macelleria","Punta di Coltello, salsiccia fresca di suino – Aia","400 g",0.4,3.99,2,V,"−33%, prima 5,99. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Hamburger classico di tacchino con rosmarino o di pollo – Aia","400 g",0.4,3.99,2,V,"−49%, prima 7,89. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ("Pollo","Carrefour Iper","carraia29","Macelleria","Fusi e sovracosce di pollo – Aia","al kg",1,6.39,2,V,"−30%, prima 9,13 al kg. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ("Pollo","Carrefour Iper","carraia29","Macelleria","Filetto di pollo a fette – Aia","al kg",1,11.79,2,V,"−25%, prima 15,81 al kg. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Chicken Salad, tagliata di petti di pollo – Aia","300 g",0.3,4.89,2,V,"−30%, prima 6,99. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Kebab di pollo tagliato in sfoglie – Aia","300 g",0.3,4.89,2,V,"−23%, prima 6,39. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Cordon bleu classico con cotto di tacchino e formaggio – Aia","265 g",0.265,2.99,2,V,"−25%, prima 3,99. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Valdostana, cotoletta di filetti di pollo impanati con scamorza affumicata – Aia","200 g",0.2,2.99,2,V,"−28%, prima 4,19. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ("Preparati","Carrefour Iper","carraia29","Macelleria","Chicken Crunchy Burger, hamburger impanato di pollo – Aia","240 g",0.24,2.99,2,V,"−33%, prima 4,49. Vale solo dal 23 ottobre al 15 novembre.","2026-10-23","2026-11-15"),
 ...
 # Lidl Frutta e Verdura nuovo, dal 24 al 30 settembre (lidlfv24), 7 pagine.
 # Quasi tutte le offerte ripetono identiche, stesso prezzo, quelle già lette
 # nel Lidl generale 24-30 (lidl24): Mele Gala IGP, Zucchine sfuse, Pomodori
 # Grappolo sfusi, Pomodori ciliegino Pachino IGP, Prugne, Zucca Hokkaido,
 # Uva bianca, Uva Red Globe, Patate Iodì, Carote, Pere Carmen — non
 # riscritte qui, sennò dati.py si ferma per riga doppia. Avocado e Fichi
 # freschi sono al pezzo, senza un peso: nessun prezzo per unità onesto.
 # Restano solo sei offerte che nel Lidl generale non c'erano:
 ("Frutta","Lidl","lidlfv24","Ortofrutta","Mele Golden","al kg",1,0.98,1,V,""),
 ("Verdura","Lidl","lidlfv24","Ortofrutta","Funghi Champignon","500 g confezione",0.500,1.49,2,V,"−25%, prima 1,99. Il volantino stampa 2,98 al kg. Valido dal 24 al 27 settembre.","2026-09-24","2026-09-27"),
 ("Verdura","Lidl","lidlfv24","Ortofrutta","Aglio","200 g confezione",0.200,0.98,3,V,"Il volantino stampa 4,90 al kg."),
 ("Verdura","Lidl","lidlfv24","Ortofrutta","Cavolo cappuccio","al kg",1,0.98,3,V,""),
 ("Verdura","Lidl","lidlfv24","Ortofrutta","Rape rosse precotte","500 g confezione",0.500,0.98,3,V,"Precotte, non crude. Il volantino stampa 1,96 al kg."),
 ("Verdura","Lidl","lidlfv24","Ortofrutta","Cavolo rosso","al kg",1,0.98,3,V,""),

 # Mercatò, dal 17 al 30 settembre. Letto per intero, 20 pagine.
 ("Salmone affumicato","Mercatò","mercato17","Gastronomia","Salmone affumicato scozzese – Hendricks","100 g",0.100,3.89,1,V,"Il volantino stampa 38,90 al kg."),
 ...
 ("Formaggio","Mercatò","mercato17","Freschi",'Burrata in foglia – Deliziosa',"250 g",0.250,3.59,2,V,"Il volantino stampa 14,36 al kg."),
 ...
 ("Affettati","Mercatò","mercato17","Gastronomia","Tacchino arrosto Monte San Savino, senza antibiotici","al kg (al banco)",1,14.90,3,V,"Al banco, 1,49 all'etto."),
 ...
 ("Preparati","Mercatò","mercato17","Macelleria","Cotolette o cordon bleu di pollo – Gusto Ricco","400 g",0.400,1.99,4,V,"Vari tipi. Il volantino stampa 4,98 al kg."),
 ...
 ("Panati","Mercatò","mercato17","Surgelati","Bastoncini di merluzzo surgelati, formato convenienza 24+6 gratis – Findus","750 g",0.750,6.59,10,V,"Il volantino stampa 8,79 al kg."),
 ...
 ("Spalmabili","Mercatò","mercato17","Freschi",'Original – Philadelphia',"160 g (80 g × 2)",0.160,1.74,8,V,"Solo con Fidelity Card. Il volantino stampa 10,88 al kg."),
 ...
 ("Dentifricio","Mercatò","mercato17","Cura persona",'Dentifricio Protect+ Care – Mentadent',"75 ml",0.075,1.99,17,V,"Il volantino stampa 26,53 al litro."),
 ...
 # ----- Mercatò «Promo L'Oréal», 17-30 settembre (mercatoreal17), letto per intero il 2026-09-25 dal PDF ufficiale -----
 # Pagina 1: il resto sono trattamenti, sieri, creme e tinte per capelli; pagina 2: creme viso e trucco. Nessuna categoria.
 ("Shampoo","Mercatò","mercatoreal17","Cura persona","Shampoo Elvive, vari tipi – L'Oréal","200 ml",0.200,4.90,1,V,"Il volantino stampa 24,50 al litro."),
 ("Shampoo","Mercatò","mercatoreal17","Cura persona","Shampoo 250 ml o balsamo 200 ml Ultra Dolce, vari tipi – Garnier","200 ml (balsamo)",0.200,1.89,1,V,"Stesso prezzo per lo shampoo da 250 ml: qui il conto è sul balsamo, il formato più piccolo."),
 ...
 ("Würstel","MD","md22","Salumi","Würstel di puro suino – La Fattoria","200 g (2 pezzi da 100 g)",0.200,1.00,3,V,""),
 ...
 ("Conserve","MD","md22","Dispensa","Piselli e carote – Gustato","400 g, peso sgocciolato 265 g",0.265,1.00,4,V,"Prima 1,19. Prezzo calcolato sul peso sgocciolato."),
 ...
 ("Verdura","MD","md22","Ortofrutta","Zucchine scure","al kg",1,1.99,12,V,""),
("Legumi","MD","md22","Ortofrutta","Ceci decorticati italiani – Naturali Bontà","300 g",0.300,1.39,12,V,"Prima 1,69. Secchi."),
 ("Patate","MD","md22","Ortofrutta","Patate, rete","5 kg",5,3.25,12,V,""),
...
("Suino","MD","md22","Macelleria","Tagliata di filetto di suino","300 g",0.300,3.95,13,V,""),
("Preparati","MD","md22","Macelleria","Hamburger di equino","220 g",0.220,2.90,13,V,""),
("Preparati","MD","md22","Macelleria","Polpette di suino – Aia","320 g",0.320,3.90,13,V,""),
 ("Insalata","MD","md22","Freschi","Insalata mista – Buona Spesa!","200 g",0.200,0.79,14,V,"Solo con la MD Buona Spesa Card."),
 ("Formaggio","MD","md22","Freschi","Primosale senza lattosio – Vivo Meglio","180 g",0.180,1.49,14,V,"Solo con la MD Buona Spesa Card."),
 ("Latte","MD","md22","Freschi","Latte microfiltrato parzialmente scremato senza lattosio – Vivo Meglio","1 litro",1,1.09,14,V,"Solo con la MD Buona Spesa Card."),
 ("Tonno","MD","md22","Dispensa","Tonno all'olio d'oliva – Poseidon","210 g (70 g × 3)",0.210,2.15,15,V,"Solo con la MD Buona Spesa Card. Senza tessera 2,59."),
 ("Panati","MD","md22","Surgelati","Croccantelle di filetto di merluzzo pomodoro/spinaci – Le Specialità di Beppe","400 g (4 pezzi)",0.400,2.99,15,V,"Solo con la MD Buona Spesa Card. Senza tessera 4,49. Sono impanate, non filetto puro."),
 ("Merendine","MD","md22","Colazione","10 Plum cake cioccolato – La Dolce","420 g",0.420,1.59,15,V,"Solo con la MD Buona Spesa Card. Senza tessera 2,29."),
 ("Bibite","MD","md22","Bevande",'Regular/zero – Coca-Cola',"1,75 litri",1.75,1.79,15,V,"Solo con la MD Buona Spesa Card. Senza tessera 2,49."),
 ("Dentifricio","MD","md22","Cura persona",'Dentifricio P – Mentadent',"100 ml",0.100,1.59,15,V,"Solo con la MD Buona Spesa Card. Senza tessera 1,99."),
 ("Carta igienica","MD","md22","Cura casa","Carta igienica 6 rotoli 3 veli – Flou","6 rotoli",6,3.49,15,V,""),
 ("Prosciutto","MD","md22","Gastronomia","Speck IGP Alto Adige – Lettere dall'Italia","100 g",0.100,1.69,15,V,"Solo con la MD Buona Spesa Card. Senza tessera 1,85."),
 ("Yogurt","MD","md22","Freschi","Yogurt Bifidus bianco naturale – Bontà Viva","1 kg (125 g × 8)",1.0,1.99,16,V,"Prima 2,79."),
 ("Ricotta","MD","md22","Freschi","Ricotta in fuscella – Buona Spesa!","330 g",0.330,1.49,16,V,"Prima 1,79."),
 ("Formaggio","MD","md22","Freschi","Formaggio fuso a fette – Malga Paradiso","400 g",0.400,1.99,16,V,"Prima 2,25."),
 ("Spalmabili","MD","md22","Freschi","Robiola","200 g (100 g × 2)",0.200,1.49,16,V,"Prima 2,29."),
 ("Mozzarella","MD","md22","Freschi","Fior di latte senza lattosio – Sabelli","300 g (100 g × 3)",0.300,2.29,16,V,"Prima 2,59."),
 ("Formaggio","MD","md22","Freschi","Formaggio italiano grattugiato – Malga Paradiso","100 g",0.100,1.09,16,V,"Prima 1,39. È un formaggio grattugiato generico, non vero grana."),
 ("Formaggio","MD","md22","Freschi","Blu di Capra dolce – Igor","150 g",0.150,3.39,16,V,"Prima 3,99."),
 ("Salmone affumicato","MD","md22","Freschi","Salmone Norvegese affumicato – Fish&Fine","80 g",0.080,2.99,16,V,"Prima 3,99."),
 ("Prosciutto","MD","md22","Freschi","Prosciutto cotto alta qualità – Buona Spesa!","100 g",0.100,1.19,17,V,"Prima 1,45."),
 ("Salame","MD","md22","Freschi","Capocollo affettato stagionato – Buona Spesa!","100 g",0.100,2.00,17,V,"Prima 2,59. È capocollo, cioè coppa."),
 ("Affettati","MD","md22","Freschi","Petto di tacchino arrosto nazionale selezione – La Fattoria","100 g",0.100,1.99,17,V,"Prima 2,49."),
 ("Bresaola","MD","md22","Freschi","Bresaola punta d'anca, bassa salatura – La Delicata","80 g",0.080,2.59,17,V,"Prima 3,29."),
 ("Prosciutto","MD","md22","Freschi","Prosciutto cotto a cubetti – La Fattoria","160 g",0.160,1.39,17,V,"Prima 1,69."),
 ("Pasta","MD","md22","Freschi","Gran Tortello porcini/Tortelloni salmone/Ravioli tartufo – Ca' Bianca","250 g",0.250,1.49,17,V,"Prima 1,99."),
 ("Pizza","MD","md22","Surgelati","Pizza Margherita XXL – Il Forno di Visso","460 g",0.460,2.99,18,V,"Prima 3,89."),
 ("Pane","MD","md22","Surgelati","Focaccia farcita prosciutto cotto/provola","390 g",0.390,2.49,18,V,"Prima 3,29."),
 ("Verdure surgelate","MD","md22","Surgelati","Cavolfiore a rosette – Le Specialità di Beppe","600 g",0.600,1.19,18,V,"Prima 1,69."),
 ("Gamberi","MD","md22","Surgelati","Code di mazzancolle tropicali sgusciate","200 g",0.200,2.99,18,V,"Prima 4,15."),
 ("Pesce","MD","md22","Surgelati","Filetto di pangasio senza pelle – Le Specialità di Beppe","480 g",0.480,2.49,18,V,"Prima 3,59. È pangasio, pesce d'allevamento economico: non paragonabile a pesce pregiato."),
 ("Gelato","MD","md22","Surgelati","8 Mini stecchi assortiti – Le Specialità di Beppe","250 g",0.250,2.49,18,V,"Prima 2,89."),
 ("Gelato","MD","md22","Surgelati","6 Coni classico/amarena/vaniglia e cacao – Le Specialità di Beppe","450 g",0.450,2.19,18,V,"Prima 2,89."),
 ("Gelato","MD","md22","Surgelati","Affogato caffè/amarena/cacao/frutti di bosco – Buona Spesa!","500 g",0.500,1.99,18,V,"Prima 2,89."),
 ("Vino","MD","md22","Bevande","Spumante Gran Cuvée brut","750 ml",0.750,1.79,19,V,"Prima 2,29."),
 ("Vino","MD","md22","Bevande","Cerasuolo d'Abruzzo DOC – Derio","750 ml",0.750,1.59,19,V,"Prima 1,99."),
 ("Vino","MD","md22","Bevande","Syrah Terre Siciliane IGP – Tenute Varvari","750 ml",0.750,1.59,19,V,"Prima 1,69."),
 ("Vino","MD","md22","Bevande","Vino Soave DOC – Le Cortigiane","750 ml",0.750,1.59,19,V,"Prima 1,99."),
 ("Birra","MD","md22","Bevande","Birra Contessa blanche","500 ml",0.500,1.59,19,V,"Prima 1,99."),
("Birra","MD","md22","Bevande","Birra Contessa IPA","500 ml",0.500,1.69,19,V,"Prima 1,99."),
 ("Pomodoro","MD","md22","Dispensa","Pomodori pelati – Gustato","400 g, peso sgocciolato 240 g",0.240,0.45,20,V,"Prima 0,69. Prezzo calcolato sul peso sgocciolato."),
 ("Pomodoro","MD","md22","Dispensa","Passata di pomodoro con basilico – Gustato","690 g",0.690,0.89,20,V,"Prima 1,09."),
 ("Conserve","MD","md22","Dispensa","Funghi champignon trifolati – Jolie","180 g",0.180,0.99,20,V,"Prima 1,09."),
 ("Merendine","MD","md22","Colazione","10 Merendine ricoperte al cacao – Midi CiaoCiò","350 g",0.350,1.49,20,V,"Prima 1,69."),
 ("Merendine","MD","md22","Colazione","Croissant ripieni crema al cioccolato","252 g",0.252,1.49,20,V,"Prima 1,99."),
 ("Biscotti","MD","md22","Colazione","Frollini con zucchero di canna – Le Bon","700 g",0.700,1.69,21,V,"Prima 2,19."),
 ("Cereali","MD","md22","Colazione","Honey Snackies – Manusol","375 g",0.375,1.49,21,V,"Prima 1,79."),
 ("Merendine","MD","md22","Colazione","Sfogliaciok – Pasticceria del Centro","200 g",0.200,1.15,21,V,"Prima 1,49."),
 ("Biscotti","MD","md22","Colazione","Twin Go vaniglia – Gullón","290 g",0.290,1.15,21,V,"Prima 1,69."),
 ("Cioccolato","MD","md22","Colazione","Snack Cioko Più assortiti – Witor's","126 g",0.126,1.69,21,V,"Prima 1,99."),
 ("Miele","MD","md22","Dispensa","Miele di Acacia squeeze – Apisol","350 g",0.350,2.89,21,V,"Prima 3,19."),
 ("Lavatrice","MD","md22","Cura casa","Detersivo lavatrice muschio bianco, 56 lavaggi – Omino Bianco","2,24 litri",56,4.69,23,V,"Prima 5,59."),
 ("Lavatrice","MD","md22","Cura casa","Detersivo lavatrice color+, 56 lavaggi – Omino Bianco","2,24 litri",56,4.69,23,V,"Prima 5,59."),
 ("Lavatrice","MD","md22","Cura casa",'Pods 15 capsule regolare – Dash',"15 capsule",15,3.99,23,V,"Prima 5,49."),
 ("Latte","MD","md22","Freschi","Latte parzialmente scremato UHT – Parmalat","1 litro",1,1.29,24,V,"Prima 1,65."),
 ("Sughi","MD","md22","Dispensa","Gran Ragù assortito – Star","360 g (180 g × 2)",0.360,2.19,25,V,"Prima 2,79."),
 ("Bibite","MD","md22","Bevande",'Regular/zero – Pepsi',"500 ml",0.500,0.65,25,V,"Prima 0,85."),
 ("Biscotti","MD","md22","Colazione","Mikado cioccolato bianco/fondente/al latte – Lu","70 g",0.070,1.39,25,V,"Prima 1,89. Il prezzo è calcolato sulla confezione più piccola, 70 g: quella da 75 g costa meno al kg."),
 ("Merendine","MD","md22","Colazione","Colazione Più, 10 merendine – Kinder","290 g",0.290,2.49,25,V,"Prima 2,89."),
 ("Bagnoschiuma","MD","md22","Cura persona","Bagnodoccia – Borotalco/Neutro Roberts","900 ml (450 ml × 2)",0.900,3.89,25,V,"Prima 4,69."),
 ("Manzo","MD","md22","Macelleria","Tartare di bovino di razza Chianina – Lettere dall'Italia","160 g",0.160,3.99,36,V,"Weekend più Uno: vale solo dal 2 al 5 ottobre, non per tutto il volantino.","2026-10-02","2026-10-05"),
 ("Sughi","MD","md22","Dispensa","Pesto verde biologico senza aglio","85 g",0.085,1.39,36,V,"Prima 1,59. Weekend più Uno: vale solo dal 2 al 5 ottobre, non per tutto il volantino.","2026-10-02","2026-10-05"),
 ("Olio di semi","MD","md22","Dispensa","Olio di semi di mais – Semì","1 litro",1,1.69,36,V,"Prima 1,89. Weekend più Uno: vale solo dal 2 al 5 ottobre, non per tutto il volantino.","2026-10-02","2026-10-05"),
 ("Biscotti","MD","md22","Colazione","Biscotti ai cereali – Le Bon","500 g (250 g × 2)",0.500,1.29,36,V,"Prima 1,59. Weekend più Uno: vale solo dal 2 al 5 ottobre, non per tutto il volantino.","2026-10-02","2026-10-05"),
 ...
 ("Collutorio","Bennet","bennet1709","Cura persona","Collutorio Total Care denti e gengive – Listerine","600 ml",0.600,4.19,13,V,"−30%, prima 5,99. È collutorio, non dentifricio: il conto al litro non si confronta con un tubetto."),
 ...
 ("Bibite","Bennet","bennet1709","Bevande",'Original Taste – Coca-Cola',"2 litri",2,1.99,21,V,"−32%, prima 2,93."),
 ...
 ("Conserve","Bennet","bennet1709","Dispensa","Carne in scatola leggera di pollo, 2×140 g – Montana","280 g",0.280,1.99,20,V,"−40%, prima 3,32. È carne in scatola, non fresca."),
 ("Salmone affumicato","Bennet","bennet1709","Freschi","Salmone norvegese affumicato – Vici","200 g",0.200,5.99,19,V,"È affumicato, non fresco."),
 ...
 ("Panati","Bennet","bennet1709","Surgelati","Bastoncini di merluzzo, 12 pezzi – Findus","300 g",0.300,2.99,22,V,"−28%, prima 4,19."),
 ...
 # ----- Bennet «Offerte Extra», 24 settembre-4 ottobre (bennetextra24), letto per intero il 2026-09-25 dal PDF ufficiale -----
 # «Promozione valida in tutti i Bennet» (esclusi Albano, Biella, Gavardo, Ivrea, Milano viale Corsica, Verbania, Vercelli).
 # Tutti i prezzi scontati hanno il bollino Bennet Club. Senza categoria nel catalogo: pasta sfoglia e brisée Buitoni, Coppa
 # Malù, bevanda Barista Orasì, merenda Mellin, patatine Pai, profuma biancheria Chanteclair, crocchette Friskies, testine e
 # spazzolini Oral-B. Senza prezzo: linee Winni's e Nuvenia, spazzolino Oral-B («−30%» e basta).
 ("Affettati","Bennet","bennetextra24","Salumi","Petto di tacchino o di pollo al forno Aequilibrium – Aia","120 g",0.12,2.00,1,V,"−33% SOLO CON LA CARTA BENNET CLUB, prima 2,99."),
 ("Patate","Bennet","bennetextra24","Surgelati","Patatine We Love Croccanti surgelate – Pizzoli","750 g",0.75,1.59,1,V,"−36% SOLO CON LA CARTA BENNET CLUB, prima 2,49. Sono patatine fritte surgelate, non patate fresche."),
 ("Pasta","Bennet","bennetextra24","Dispensa","Pasta formati vari – Barilla","1 kg",1,1.09,1,V,"−41% SOLO CON LA CARTA BENNET CLUB, prima 1,86."),
 ("Olio d'oliva","Bennet","bennetextra24","Dispensa","Olio extravergine di oliva Il Frantolio – Carapelli","750 ml",0.75,5.59,1,V,"−30% SOLO CON LA CARTA BENNET CLUB, prima 7,99."),
 ("Caffè","Bennet","bennetextra24","Colazione","Caffè macinato per moka Qualità Rossa – Lavazza","500 g (2 × 250 g)",0.5,7.99,1,V,"−33% SOLO CON LA CARTA BENNET CLUB, prima 11,94."),
 ("Acqua","Bennet","bennetextra24","Bevande","Acqua naturale – Eva, conf. 6 pezzi","9 litri (6 × 1,5 l)",9,1.76,1,V,"−35% SOLO CON LA CARTA BENNET CLUB, prima 2,72."),
 ("Bresaola","Bennet","bennetextra24","Salumi","Bresaola della Valtellina IGP – Rigamonti","100 g",0.1,4.79,2,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 5,99."),
 ("Formaggio","Bennet","bennetextra24","Freschi","GranMix classico – Ferrari","100 g",0.1,1.59,2,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 1,99. Formaggio grattugiato misto, non Grana né Parmigiano."),
 ("Pizza","Bennet","bennetextra24","Surgelati","Pizza La Alta Margherita surgelata – Buitoni","375 g",0.375,2.44,2,V,"−30% SOLO CON LA CARTA BENNET CLUB, prima 3,49."),
 ("Pasta","Bennet","bennetextra24","Dispensa","Pasta integrale formati vari – La Molisana","500 g",0.5,0.99,2,V,"−40% SOLO CON LA CARTA BENNET CLUB, prima 1,65."),
 ("Pasta","Bennet","bennetextra24","Dispensa","Pasta Venere integrale formati vari – Riso Scotti","400 g",0.4,1.69,2,V,"−26% SOLO CON LA CARTA BENNET CLUB, prima 2,29. Pasta di grano e riso Venere."),
 ("Riso","Bennet","bennetextra24","Dispensa","Risotto pronto tipi vari – Knorr","175 g",0.175,1.59,2,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 1,99. È un risotto pronto da cuocere, non riso semplice."),
 ("Sughi","Bennet","bennetextra24","Dispensa","Gran Ragù – Star","300 g (3 × 100 g)",0.3,2.70,2,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 3,38."),
 ("Tonno","Bennet","bennetextra24","Dispensa","Filetti di tonno all'olio di oliva – Rio Mare","250 g",0.25,6.24,3,V,"−25% SOLO CON LA CARTA BENNET CLUB, prima 8,32."),
 ("Tonno","Bennet","bennetextra24","Dispensa","Tonno all'olio di oliva – Rio Mare","560 g (7 × 80 g)",0.56,10.49,3,V,"−30% SOLO CON LA CARTA BENNET CLUB, prima 14,99."),
 ("Pane","Bennet","bennetextra24","Dispensa","Cracker salati o non salati in superficie – Mulino Bianco","500 g",0.5,1.75,3,V,"−16% SOLO CON LA CARTA BENNET CLUB, prima 2,09."),
 ("Merendine","Bennet","bennetextra24","Colazione","Mini Fette al cioccolato, tipi vari – Mulino Bianco","110 g",0.11,1.49,3,V,"−15% SOLO CON LA CARTA BENNET CLUB, prima 1,76."),
 ("Pane","Bennet","bennetextra24","Colazione","Fette biscottate senza zuccheri aggiunti o multicereali – Misura","320 g",0.32,1.59,3,V,"−15% SOLO CON LA CARTA BENNET CLUB, prima 1,88. Sono fette biscottate."),
 ("Biscotti","Bennet","bennetextra24","Colazione","Biscotti Bucaneve Maxigocce XL o Ciocco integrale – Doria","300 g",0.3,1.45,3,V,"−14% SOLO CON LA CARTA BENNET CLUB, prima 1,69."),
 ("Biscotti","Bennet","bennetextra24","Colazione","Biscotti Ricchi Fagottini, Gocciolotti o Saracene – Balocco","700 g",0.7,2.68,3,V,"−18% SOLO CON LA CARTA BENNET CLUB, prima 3,28."),
 ("Merendine","Bennet","bennetextra24","Colazione","Trancino, conf. 24 pezzi – Mulino Bianco","792 g",0.792,3.98,3,V,"−15% SOLO CON LA CARTA BENNET CLUB, prima 4,69."),
 ("Biscotti","Bennet","bennetextra24","Colazione","Kinderini – Kinder","225 g",0.225,2.79,3,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 3,49."),
 ("Marmellata","Bennet","bennetextra24","Colazione","Zero zuccheri aggiunti, gusti vari – Zuegg","220 g",0.22,2.39,3,V,"−25% SOLO CON LA CARTA BENNET CLUB, prima 3,19."),
 ("Caffè","Bennet","bennetextra24","Colazione","Capsule caffè Espresso Napoli, 16 capsule – Kimbo","112 g",0.112,3.99,3,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 4,99. Compatibili Nescafé Dolce Gusto."),
 ("Acqua","Bennet","bennetextra24","Bevande","Acqua effervescente naturale – Lete, conf. 6 pezzi","3 litri (6 × 500 ml)",3,1.34,4,V,"−30% SOLO CON LA CARTA BENNET CLUB, prima 1,92."),
 ("Bibite","Bennet","bennetextra24","Bevande","Bevanda alla frutta senza zuccheri aggiunti Skipper, gusti vari – Zuegg","1 litro",1,1.49,4,V,"−25% SOLO CON LA CARTA BENNET CLUB, prima 1,99."),
 ("Birra","Bennet","bennetextra24","Bevande","Birra Fresca come alla spina – Tuborg","660 ml",0.66,0.99,4,V,"−27% SOLO CON LA CARTA BENNET CLUB, prima 1,36."),
 ("Birra","Bennet","bennetextra24","Bevande","Birra Strong Lager – Tennent's Super","355 ml",0.355,1.59,4,V,"−15% SOLO CON LA CARTA BENNET CLUB, prima 1,88."),
 ("Vino","Bennet","bennetextra24","Bevande","Umbria Rosso IGT o Spumante Brut – Vipra","750 ml",0.75,4.19,4,V,"−30% SOLO CON LA CARTA BENNET CLUB, prima 5,99."),
 ("Bagnoschiuma","Bennet","bennetextra24","Cura persona","Ecoricarica sapone classico – Felce Azzurra","500 ml",0.5,1.99,4,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 2,49."),
 ("Carta igienica","Bennet","bennetextra24","Cura casa","Carta igienica Fior di Lino Kilometrica – Tenderly","4 rotoli",4,2.79,4,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 3,49."),
 ("Lavatrice","Bennet","bennetextra24","Cura casa","Detersivo liquido capi delicati o colorati, 28 lavaggi – Perlana","1,4 litri",28,4.78,4,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 5,98."),
 ("Lavatrice","Bennet","bennetextra24","Cura casa","Detersivo liquido, 50 lavaggi – Bio Presto","2,25 litri",50,7.15,4,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 8,94."),
 ("Ammorbidente","Bennet","bennetextra24","Cura casa","Ammorbidente concentrato, 57 lavaggi – Chanteclair","1,14 litri",57,2.39,4,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 2,99."),
 ("Lavastoviglie","Bennet","bennetextra24","Cura casa","Detergente lavastoviglie Gel Tutto in 1, 35 lavaggi – Pril","630 ml",35,4.79,4,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 5,99."),
 ("Dentifricio","Bennet","bennetextra24","Cura persona","Dentifricio 3D White Bianco Perla – Oral-B","225 ml (3 × 75 ml)",0.225,3.54,5,V,"−40% SOLO CON LA CARTA BENNET CLUB, prima 5,90."),
 ("Dentifricio","Bennet","bennetextra24","Cura persona","Dentifricio Complete Protezione e Pulizia – Oral-B","225 ml (3 × 75 ml)",0.225,3.54,5,V,"−40% SOLO CON LA CARTA BENNET CLUB, prima 5,90."),
 ("Dentifricio","Bennet","bennetextra24","Cura persona","Dentifricio Complete Freschezza Estrema – Oral-B","225 ml (3 × 75 ml)",0.225,3.54,5,V,"−40% SOLO CON LA CARTA BENNET CLUB, prima 5,90."),
 ("Mozzarella","Bennet","bennetextra24","Freschi","Mozzarella per pizza Santa Lucia – Galbani","400 g",0.4,3.57,7,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 4,47."),
 ("Mozzarella","Bennet","bennetextra24","Freschi","Mozzarella al basilico Santa Lucia – Galbani","125 g",0.125,1.35,7,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 1,69."),
 ("Formaggio","Bennet","bennetextra24","Freschi","Burrata Santa Lucia – Galbani","120 g",0.12,1.82,7,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 2,28. È burrata, non mozzarella."),
 ("Formaggio","Bennet","bennetextra24","Freschi","Stracciatella Santa Lucia – Galbani","140 g",0.14,1.82,7,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 2,28."),
 ("Formaggio","Bennet","bennetextra24","Freschi","Fettine classiche, 14 fette – Kraft","350 g",0.35,2.79,7,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 3,49. Sono formaggio fuso a fette."),
 ("Formaggio","Bennet","bennetextra24","Freschi","Fettine senza lattosio, 7 fette – Kraft","175 g",0.175,1.49,7,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 1,87. Sono formaggio fuso a fette."),
 ("Formaggio","Bennet","bennetextra24","Freschi","Fettine light, 7 fette – Kraft","175 g",0.175,1.59,7,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 1,99. Sono formaggio fuso a fette."),
 ("Formaggio","Bennet","bennetextra24","Freschi","Fettine burger con cheddar, 7 fette – Kraft","175 g",0.175,1.49,7,V,"−20% SOLO CON LA CARTA BENNET CLUB, prima 1,87. Sono formaggio fuso a fette."),
 ("Formaggio","Bennet","bennetextra24","Gastronomia","Taleggio DOP – Cademartori","al kg",1,13.90,8,V,"Al banco."),
 ("Formaggio","Bennet","bennetextra24","Gastronomia","Quartirolo DOP – Cademartori","al kg",1,11.90,8,V,"Al banco."),
 ("Formaggio","Bennet","bennetextra24","Gastronomia","Formaggio Bel Paese – Galbani","al kg",1,12.90,8,V,"Al banco."),
 ("Ricotta","Bennet","bennetextra24","Freschi","Ricotta tradizionale in cestello – Vallelata","280 g",0.28,1.90,8,V,""),
 ("Spalmabili","Bennet","bennetextra24","Freschi","Crema Bel Paese, 8 formaggini – Galbani","175 g",0.175,1.19,8,V,"−25% SOLO CON LA CARTA BENNET CLUB, prima 1,59."),
 ...
 ("Prosciutto","Eurospin","eurospin24","Salumi","Prosciutto Crudo","100 g",0.100,1.79,4,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 2,49. Prima 2,49."),
 ("Prosciutto","Eurospin","eurospin24","Salumi","Speck Alto Adige IGP","100 g",0.100,1.45,4,V,"Prima 1,85."),
 ("Affettati","Eurospin","eurospin24","Salumi","Petto di pollo al forno – Fresche Fette","140 g",0.140,1.29,4,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 1,89. Prima 1,89. È petto di pollo cotto (un salume), non carne fresca. Solo 2% di grassi."),
 ("Würstel","Eurospin","eurospin24","Salumi","Würstel con pollo e tacchino","1 kg",1,1.99,4,V,"Prima 2,59."),
 ...
 ("Salame","Eurospin","eurospin24","Salumi","Coppa stagionata nostrana","100 g",0.100,2.39,4,V,"Prima 2,99. Capocollo stagionato, carne italiana."),
 ("Preparati","Eurospin","eurospin24","Freschi","Burgheroni gusti assortiti, 2x75 g","150 g",0.150,1.39,4,V,"Prima 1,79."),
 ...
 ("Salmone affumicato","Eurospin","eurospin24","Freschi","Salmone Norvegese Affumicato","150 g",0.150,2.99,5,V,"Prima 3,99."),
 ("Pane","Eurospin","eurospin24","Freschi","Piadina Romagnola IGP alla Riminese","600 g",0.600,1.29,5,V,"Prima 1,69."),
 ("Yogurt","Eurospin","eurospin24","Freschi","Yogurt Cremoso Extra alla vaniglia/bianco","150 g",0.150,0.55,5,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 0,75. Prima 0,75."),
 ...
 ("Miele","Eurospin","eurospin24","Dispensa","Miele Millefiori","500 g",0.500,2.39,6,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 3,49. Prima 3,49."),
 ...
 ("Conserve","Eurospin","eurospin24","Dispensa","Carne in gelatina, 6x90 g","540 g",0.540,4.49,6,V,"Prima 5,99. Carne in scatola."),
 ("Conserve","Eurospin","eurospin24","Dispensa","Fagioli e tonno/Piselli e tonno, 2x160 g","320 g",0.320,1.69,6,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 2,29. Prima 2,29."),
 ("Bibite","Eurospin","eurospin24","Bevande","Bevande assortite ACE, 6x200 ml","1200 ml",1.2,1.29,7,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 1,75. Prima 1,75."),
 ...
 ("Birra","Eurospin","eurospin24","Bevande","Birra Premium Strong Doppio Malto – Best Bräu","500 ml",0.500,0.65,7,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 0,89. Prima 0,89. 8,3% vol."),
 ...
 ("Merendine","Eurospin","eurospin24","Dispensa","Trancino con crema al latte – Dolciando","270 g",0.270,1.69,7,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 2,39. Prima 2,39."),
 ("Carta igienica","Eurospin","eurospin24","Casa",'Carta igienica, 6 rotoli, 4 veli, 150 strappi – La Fiorita',"6 rotoli",6,1.69,8,V,"Prima 2,49."),
 ...
 ("Salmone","Eurospin","eurospin24","Surgelati","Filetti di salmone Norvegese, 2 pz","250 g",0.250,4.85,9,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 6,49. Prima 6,49. Surgelato."),
 ("Pizza","Eurospin","eurospin24","Surgelati","Pizza würstel e patatine/integrale","225 g",0.225,1.89,9,V,"Surgelata."),
 ("Gelato","Eurospin","eurospin24","Surgelati","Vaschette gelato assortite","500 g",0.500,1.99,9,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 2,69. Prima 2,69."),
 ...
 ("Preparati","Eurospin","eurospin24","Macelleria","Hamburger di Chianina","200 g",0.200,3.49,10,V,"100% carne italiana."),
 ("Preparati","Eurospin","eurospin24","Macelleria","Hamburger di suino, 4x100 g","400 g",0.400,2.49,10,V,""),
 ("Preparati","Eurospin","eurospin24","Macelleria","Hamburger di pollo","200 g",0.200,1.29,10,V,""),
 ("Panati","Eurospin","eurospin24","Surgelati","Fishburger di filetto di merluzzo, 2 pz","210 g",0.210,1.79,10,V,"Prima 2,29. Surgelato."),
 ...
 ("Formaggio","Eurospin","eurospin24","Freschi","Edamer a fette","200 g",0.200,1.29,11,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 1,79. Prima 1,79."),
 ...
 ("Preparati","Eurospin","eurospin24","Freschi","Burger di soia – Amo Essere Veg, 2x100 g","200 g",0.200,1.99,11,V,"Prima 2,59. Vegano."),
 ("Conserve","Eurospin","eurospin24","Dispensa","Cetrioli aromatizzati – Di Maggio, 670 g/sgocc. 370 g","370 g",0.370,0.99,11,V,"Prima 1,29. Il conto usa il peso sgocciolato."),
 ...
 ("Frutta","Eurospin","eurospin24","Ortofrutta","Arance Valencia","1,5 kg",1.5,2.49,12,V,"Vale solo dal 28 settembre al 4 ottobre.","2026-09-28","2026-10-04"),
 ("Verdura","Eurospin","eurospin24","Ortofrutta","Zucchine","al kg",1,1.29,12,V,"Vale solo dal 28 settembre al 4 ottobre.","2026-09-28","2026-10-04"),
 ("Insalata","Eurospin","eurospin24","Ortofrutta","Insalata mista","200 g",0.200,0.79,12,V,"Vale solo dal 28 settembre al 4 ottobre.","2026-09-28","2026-10-04"),
 ...
 ("Panati","Eurospin","eurospin24","Pescheria","Fritto misto","250 g",0.250,3.99,12,V,"Solo nei punti vendita con reparto pescheria. Misto di anelli e simili già pronto."),
 ...
 ("Preparati","Eurospin","eurospin24","Macelleria","Rotolo con spinaci","680 g",0.680,4.99,13,V,""),
 ("Gelato","Eurospin","eurospin24","Surgelati","Gelatini mix, 9 pz","300 g",0.300,3.19,14,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 3,99. Pagina «Offerte Family»: segnata solo con la carta per prudenza. Prima 3,99."),
 ("Pancetta","Eurospin","eurospin24","Salumi","Pancetta coppata","100 g",0.100,2.19,14,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 2,69. Pagina «Offerte Family»: segnata solo con la carta per prudenza. Prima 2,69."),
 ("Salame","Eurospin","eurospin24","Salumi","Salame Nostrano","100 g",0.100,2.19,14,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 2,59. Pagina «Offerte Family»: segnata solo con la carta per prudenza. Prima 2,59. Carne italiana."),
 ("Pomodoro","Eurospin","eurospin24","Dispensa","Pomodori pelati, 800 g/sgocc. 500 g","500 g",0.500,0.75,14,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 1,09. Pagina «Offerte Family»: segnata solo con la carta per prudenza. Prima 1,09. Il conto usa il peso sgocciolato."),
 ("Olio di semi","Eurospin","eurospin24","Dispensa","Prodotto per friggere","1 l",1,1.49,14,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 1,99. Pagina «Offerte Family»: segnata solo con la carta per prudenza. Prima 1,99."),
 ("Legumi","Eurospin","eurospin24","Dispensa","Fagioli Red Kidney, 410 g/sgocc. 242 g","242 g",0.242,0.49,14,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 0,69. Pagina «Offerte Family»: segnata solo con la carta per prudenza. Prima 0,69. Il conto usa il peso sgocciolato."),
 ("Pane","Eurospin","eurospin24","Dispensa","Panetti croccanti con sesamo","300 g",0.300,2.29,14,V,"Offerta Family: solo con la carta Eurospin Family, senza tessera 2,69. Pagina «Offerte Family»: segnata solo con la carta per prudenza. Prima 2,69."),
...
# sottoperiodo diverso da quello del volantino intero.
 ...
 ("Preparati","Lidl","lidl24","Macelleria","Hamburger di bovino di razza Piemontese","200 g",0.200,2.99,8,V,"Prima 3,49."),
 ...
 ("Preparati","Lidl","lidl24","Macelleria","Spiedini piccanti di pollo e suino","500 g",0.500,4.79,8,V,"È misto pollo e suino, non solo suino."),
 ...
 ("Preparati","Lidl","lidl24","Macelleria","Gran burger di pollo XXL con panatura croccante","560 g",0.560,4.49,9,V,"Panato, non petto puro."),
 ("Preparati","Lidl","lidl24","Macelleria","Cotoletta croccante di pollo","220 g",0.220,1.99,9,V,"Panata, non petto puro."),
 ("Preparati","Lidl","lidl24","Macelleria","Polpettine di tacchino con suino","360 g",0.360,2.79,9,V,"Contengono anche suino, non solo tacchino."),
 ("Affettati","Lidl","lidl24","Salumi","Affettato di petto di tacchino o di pollo – Idee Gustose","140 g",0.140,1.79,15,V,"Senza glutine. Stesso prezzo anche nella versione pollo."),
 ...
 ("Panati","Lidl","lidl24","Surgelati","Anelli di totano in pastella con aglio e prezzemolo – Sol&Mar","500 g",0.500,2.79,46,V,"In pastella, surgelati."),
 ...
 ("Salame","Lidl","lidl24","Salumi","Chorizo affettato – Sol&Mar","100 g",0.100,1.49,44,V,"È chorizo, salsiccia spagnola piccante di carne suina."),
 ...
 ("Birra","Lidl","lidl24","Bevande",'Birra 4,7% Vol. – Peroni',"0,5 litri",0.500,0.79,1,V,""),
 ...
 ("Bibite","Lidl","lidl24","Bevande",'Zero – Coca-Cola, senza zuccheri caffeina e calorie',"0,5 litri",0.500,0.75,11,V,""),
 ("Bibite","Lidl","lidl24","Bevande",'Regular – Coca-Cola',"4x0,5 litri",2,2.99,49,V,"","2026-09-28","2026-09-30"),
...
# nessuna pagina ha un periodo più corto.
 ...
 ("Conserve","Ekom","ekom22","Dispensa","Filetti di salmone all'olio vegetale","150 g",0.150,2.49,3,V,"È in scatola, non fresco."),
 ...
 ("Preparati","Ekom","ekom22","Salumi","Fette di cotechino senza glutine","150 g (3 fette)",0.150,1.49,7,V,"Prima 1,99. È cotechino, salume cotto di maiale, non salsiccia fresca."),
 ("Würstel","Ekom","ekom22","Salumi","Würstel Griglia&Famiglia","1 kg",1,2.59,7,V,"Sono würstel, non carne fresca."),
 ...
 ("Preparati","Ekom","ekom22","Macelleria","Rustichelle di pollo BBQ","al kg",1,13.90,9,V,"Vale solo nei negozi col banco servito."),
 ...
 ("Preparati","Ekom","ekom22","Macelleria","Polpettine di carne bovina – Amica Natura","500 g",0.500,3.99,14,V,"Solo con la carta EKOM UP. Senza tessera 4,99."),
 ("Spalmabili","Ekom","ekom22","Freschi",'Classico – Philadelphia',"220 g",0.220,2.19,14,V,"Solo con la carta EKOM UP."),
 ...
 ("Bibite","Ekom","ekom22","Bevande",'Classica – Coca Cola, 6x330 ml',"1,98 litri",1.98,3.99,14,V,"Solo con la carta EKOM UP. Senza tessera 4,99."),
 ...
 ("Panati","Ekom","ekom22","Surgelati","Filetti di platessa impanati","300 g",0.300,2.99,15,V,"Prima 3,99. Sono impanate."),
 ...
 ("Salmone affumicato","Ekom","ekom22","Freschi","Salmone affumicato","200 g",0.200,5.49,16,V,""),
 ...
 ("Preparati","Ipercoop","ipercoop24","Macelleria","Hamburger di chianina – Linea You&Meat","200 g",0.200,4.49,1,V,"Bollino «Conviene». Il volantino stampa 22,45 al kg. Ci sono anche altri tipi allo stesso prezzo."),
 ...
 ("Dentifricio","Ipercoop","ipercoop24","Igiene",'Dentifricio P white system o microgranuli – Mentadent',"4 × 75 ml (1+1 da due)",0.300,4.85,2,V,"È un 1+1: si pagano 4,85 e si portano via due confezioni da due tubetti. Una confezione sola costa 4,85. Il volantino stampa 16,17 al litro."),
 ...
 ("Lavatrice","Ipercoop","ipercoop24","Cura casa",'Detersivo liquido per lavatrice classico – Dash',"3,105 litri, 3 × 23 lavaggi",69,11.85,2,V,"Sconto del 50%: prima 23,70. Offerta limitata. Il volantino stampa 3,82 al litro."),
 # --- pagina 3 («1,2,3 più compri meno paghi») ---
 ("Preparati","Ipercoop","ipercoop24","Macelleria","Hamburgerini di scottona – Fior Fiore","240 g",0.240,6.28,3,V,"Prezzo di una confezione sola (26,17 al kg). Comprandone due 10,04 (5,02 l'una), tre 13,17 (4,39 l'una, cioè 18,29 al kg). Dal quarto pezzo in poi si paga il prezzo più basso; massimo 12 pezzi per scontrino."),
 ...
 ("Würstel","Ipercoop","ipercoop24","Freschi",'Würstel Wudy Cocktail – AIA',"350 g",0.350,2.99,3,V,"Sono würstel di pollo e tacchino. Prezzo di una confezione sola (8,54 al kg). Comprandone due 4,18 (2,09 l'una), tre 5,37 (1,79 l'una, cioè 5,11 al kg)."),
 ...
 ("Biscotti","Ipercoop","ipercoop24","Colazione",'Biscotto Salute classico o integrale – Monviso',"500 g",0.500,3.09,7,V,"Bollino «Conviene». Il volantino stampa 6,18 al kg."),
 ...
 ("Merendine","Ipercoop","ipercoop24","Colazione",'Pandorì classico o farcito – Bauli, formati vari',"150 g (classico)",0.150,1.79,7,V,"Bollino «Conviene». Il conto è sul formato classico da 150 g. Il volantino stampa 11,93 al kg."),
 ("Biscotti","Ipercoop","ipercoop24","Colazione",'Biscotti Oro 5 cereali – Saiwa',"420 g",0.420,1.79,7,V,"Bollino «Conviene». Il volantino stampa 4,26 al kg."),
 # --- pagina 8 ---
 ...
 # --- pagina 10 (bevande) ---
 ("Birra","Ipercoop","ipercoop24","Bevande",'Birra anima sarda – Ichnusa',"660 ml",0.660,0.95,10,V,"Bollino «Conviene». Il volantino stampa 1,44 al litro."),
 ...
 ("Bibite","Ipercoop","ipercoop24","Bevande",'Classica o zero – Pepsi',"2 litri",2,1.39,10,V,"Bollino «Conviene». Il volantino stampa 0,70 al litro."),
 ("Acqua","Ipercoop","ipercoop24","Bevande",'Acqua naturale – Levissima',"1,5 litri",1.5,0.31,10,V,"Solo per i soci Coop. Il volantino stampa 0,21 al litro."),
 # --- pagina 11 (surgelati) ---
 ...
 ("Panati","Ipercoop","ipercoop24","Surgelati","Fiori di merluzzo d'Alaska – Capitan Findus, 10 pezzi","500 g",0.500,7.69,11,V,"Solo per i soci Coop. Il volantino stampa 15,38 al kg."),
 ...
 ("Panati","Ipercoop","ipercoop24","Surgelati",'Croccole di merluzzo – Capitan Findus, 2 pezzi',"216 g",0.216,2.79,11,V,"Solo per i soci Coop. Sono impanate, non filetto nudo. Il volantino stampa 12,92 al kg."),
 ...
 ("Spalmabili","Ipercoop","ipercoop24","Freschi",'Light – Philadelphia',"210 g",0.210,1.99,12,V,"Solo per i soci Coop. Il volantino stampa 9,48 al kg."),
 ...
 ("Preparati","Ipercoop","ipercoop24","Macelleria",'Linea Mini Spiedini – Martini, tipi vari',"300 g (di suino)",0.300,3.71,14,V,"Sconto soci del 30%: senza tessera 5,30, cioè 17,67 al kg. Il conto è sul formato di suino da 300 g. Il volantino stampa 12,37 al kg."),
 ("Preparati","Ipercoop","ipercoop24","Macelleria",'Linea Fidatissimi – Amadori, tipi e formati vari',"600 g (cotoletta)",0.600,5.57,14,V,"Sconto soci del 40%: 7,43 con lo sconto del 20% per tutti (12,38 al kg), 9,29 senza sconti (15,49 al kg). Il conto è sulla cotoletta da 600 g. Il volantino stampa 9,28 al kg col prezzo soci."),
 ...
 ("Preparati","Ipercoop","ipercoop24","Macelleria",'Mini rollé di pollo – Fileni',"600 g",0.600,6.99,14,V,"Bollino «Conviene». Sono di pollo con suino e tacchino. Il volantino stampa 11,65 al kg."),
 ("Preparati","Ipercoop","ipercoop24","Macelleria",'Linea Bon Roll di tacchino – AIA, vari gusti',"680 g",0.680,6.99,14,V,"Bollino «Conviene». Il volantino stampa 10,28 al kg."),
 ...
 ("Salmone affumicato","Ipercoop","ipercoop24","Freschi",'Trancio di salmone affumicato a caldo – Mowi, gusti vari',"125 g",0.125,5.19,15,V,"Sconto del 20%: prima 6,49, cioè 51,92 al kg. È affumicato, non salmone fresco. Il volantino stampa 41,52 al kg."),
 ...
 ("Preparati","Ipercoop","ipercoop24","Macelleria",'Linea Bombette pugliesi – Zì Marì',"280 g",0.280,4.49,19,V,"Bollino «Conviene». Sono involtini di suino da cuocere. Il volantino stampa 16,04 al kg."),
 ...
 # --- pagina 22 (igiene) ---
 ("Dentifricio","Ipercoop","ipercoop24","Igiene",'Dentifricio tripla protezione – Aquafresh',"450 ml (6 × 75 ml)",0.450,4.79,22,V,"Bollino «Conviene». Il volantino stampa 10,64 al litro."),
 ...
 ("Lavatrice","Ipercoop","ipercoop24","Cura casa",'Detersivo per lavatrice liquido concentrato Pods – Dash',"1,086 kg, 60 lavaggi",60,13.65,25,V,"Sconto del 40%: prima 22,75, cioè 20,95 al kg. Offerta limitata. Il volantino stampa 12,57 al kg."),
 ...
 # --- pagina 43 (bibite) ---
 ("Bibite","Ipercoop","ipercoop24","Bevande",'Original o zero – Coca Cola',"6 litri (4 × 1,5 l)",6,4.99,43,V,"Solo per i soci Coop. Il volantino stampa 0,83 al litro."),
 ("Bibite","Ipercoop","ipercoop24","Bevande",'Tonic water – Kinley, gusti vari',"1 litro",1,0.89,43,V,"Solo per i soci Coop."),
 ...
 ("Bibite","Ipercoop","ipercoop24","Bevande",'Mini – Fuze Tea, limone o pesca',"1 litro (4 × 250 ml)",1,1.99,43,V,"Solo per i soci Coop."),
 ...
 ("Biscotti","Pam","pam24","Colazione",'Biscotti: grottoli con gocce di cioccolato – Divella, ottimini integrali, grano saraceno',"350 g",0.350,1.00,3,V,"Formati da 350 o 400 g allo stesso prezzo: il conto è sul più piccolo (2,86 al kg)."),
 ...
 ("Preparati","Pam","pam24","Freschi",'Nuggets di pollo «Panatine» – Rovagnati',"144 g",0.144,2.00,5,V,"Il volantino stampa 13,89 al kg."),
 ...
 ("Panati","Pam","pam24","Surgelati",'2 Croccole di merluzzo – Findus, le originali o agli spinaci',"200 g (agli spinaci)",0.200,3.00,7,V,"Formati da 216 g (originali) o 200 g (agli spinaci) allo stesso prezzo: il conto è sul più piccolo (15,00 al kg)."),
 ...
 ("Affettati","Pam","pam24","Gastronomia","Fesa di tacchino arrosto","all'etto",0.1,1.49,9,V,"Al banco. Prima 1,89."),
 ...
 ("Preparati","Pam","pam24","Macelleria","Maxi hamburger di scottona skin – Tesori dell'Arca","200 g",0.200,3.90,10,V,"Il volantino stampa 19,50 al kg."),
 ("Preparati","Pam","pam24","Macelleria",'Bastoncini di pollo – Valserena',"500 g",0.500,3.69,10,V,"Il volantino stampa 7,38 al kg."),
 ("Preparati","Pam","pam24","Macelleria",'Gran Dorate alla viennese – AIA',"300 g",0.300,3.59,10,V,"Cotolette di pollo impanate. Il volantino stampa 11,97 al kg."),
 ...
 ("Caffè","Pam","pam24","Colazione",'Caffè in capsule gran crema o espresso – Pam, compatibili Nescafé Dolce Gusto',"40 capsule, 300 g",0.300,6.99,12,V,"0,18 a capsula. Il volantino stampa 23,30 al kg."),
 ...
 ("Pane","Pam","pam24","Panetteria",'Panini per hamburger – Pam, maxi hamburger o hot dog',"250 g",0.250,0.89,12,V,"Formati da 250 o 300 g allo stesso prezzo: il conto è sul più piccolo (3,56 al kg)."),
 ...
 ("Bibite","Pam","pam24","Bevande",'Regular o zero – Coca-Cola, bi-pack',"3 litri (2 × 1,5 litri)",3,2.99,15,V,"Solo con l'app Pam Perte Plus. Il volantino stampa 1,00 al litro."),
 ...
 ("Salmone affumicato","Pam","pam24","Freschi",'Salmone affumicato norvegese – Pam',"150 g",0.150,4.50,18,V,"Il volantino stampa 30,00 al kg."),
 ...
 ("Preparati","Pam","pam24","Surgelati",'Nuggets di pollo – Pam',"300 g",0.300,2.69,19,V,"Il volantino stampa 8,97 al kg."),
 ...
 ("Asciugatutto","Pam","pam24","Cura casa",'Asciugatutto decorato – Arkalia, 3 veli',"2 rotoli",2,1.49,19,V,""),
 ...
 ("Biscotti","Pam","pamextra24","Colazione",'Biscotti Pan di Stelle – Mulino Bianco, Abbracci o Nascondini',"330 g",0.330,2.00,2,V,"Formati da 330 o 350 g allo stesso prezzo: il conto è sul più piccolo (6,06 al kg)."),
 ...
 ("Merendine","Pam","pamextra24","Colazione",'Choco Brownie – Milka, Cookies o Chocowafer',"150 g",0.150,2.00,3,V,"Solo con l'app Pam Perte Plus. Formati da 150 a 184 g allo stesso prezzo: il conto è sul più piccolo (13,33 al kg)."),
 ...
 ("Yogurt","Pam","pamextra24","Freschi",'Yogurt cremoso magro o intero – Müller, gusti vari, formato risparmio',"1 kg (8 × 125 g)",1,3.39,6,V,""),
 ...
 ("Salmone affumicato","Pam","pamextra24","Freschi","Salmone scozzese affumicato – Tesori dell'Arca","100 g",0.100,5.90,7,V,"Il volantino stampa 59,00 al kg."),
 ("Salmone affumicato","Pam","pamextra24","Freschi",'Salmone norvegese affumicato – KV Nordic',"50 g",0.050,2.99,7,V,"Solo con l'app Pam Perte Plus. Il volantino stampa 59,80 al kg."),
 ...
 ("Mortadella","Pam","pamextra24","Salumi",'Mortadella affettata – Felsineo, bipack',"200 g (2 × 100 g)",0.200,3.00,8,V,"Sconto del 30%: prima 4,29. Il volantino stampa 15,00 al kg."),
 ("Würstel","Pam","pamextra24","Freschi",'Würstel «Gli Originali» di pollo – Wüber',"100 g",0.100,0.59,8,V,"Solo con l'app Pam Perte Plus. Il volantino stampa 5,90 al kg."),
 ...
 ("Spalmabili","Pam","pamextra24","Freschi",'Formaggio fresco Original – Philadelphia',"250 g",0.250,2.69,8,V,"Il volantino stampa 10,76 al kg."),
 ...
 ("Tonno","Pam","pamextra24","Dispensa","Tonno «Filo d'olio» all'olio di oliva – Rio Mare","260 g (4 × 65 g)",0.260,4.99,10,V,"Solo con l'app Pam Perte Plus. Il conto è sul peso delle scatolette, come fa il volantino (19,19 al kg)."),
 ...
 ("Preparati","Pam","pamextra24","Macelleria",'Le Tenerelle di pollo Qualità 10+ – Amadori',"300 g",0.300,3.69,13,V,"Il volantino stampa 12,30 al kg."),
 ("Preparati","Pam","pamextra24","Macelleria",'Hamburger di tacchino – Amadori',"320 g",0.320,3.15,13,V,"Il volantino stampa 9,84 al kg."),
 ("Preparati","Pam","pamextra24","Macelleria",'Cotoletta di pollo sottile – Amadori',"300 g",0.300,2.99,13,V,"Il volantino stampa 9,97 al kg."),
 ...
 ("Panati","Pam","pamextra24","Surgelati",'Filetti di platessa alla mugnaia – Pam',"250 g",0.250,3.89,14,V,"Solo con l'app Pam Perte Plus. Surgelati e già conditi. Il volantino stampa 15,56 al kg."),
 ("Panati","Pam","pamextra24","Surgelati",'Cotolette di merluzzo – Pam',"400 g",0.400,4.39,14,V,"Solo con l'app Pam Perte Plus. Il volantino stampa 10,97 al kg."),
 ("Preparati","Pam","pamextra24","Surgelati",'Ortaiola con spinaci – Amadori',"300 g",0.300,2.49,14,V,"Solo con l'app Pam Perte Plus. Cotolette di pollo con spinaci. Il volantino stampa 8,30 al kg."),
 ("Panati","Pam","pamextra24","Surgelati",'4 Fiori di merluzzo – Findus',"300 g",0.300,7.49,14,V,"Il volantino stampa 24,96 al kg."),
 ...
 ("Birra","Pam","pamextra24","Bevande",'Birra Extra o Cero – Corona',"330 ml",0.330,1.19,16,V,"Il volantino stampa 3,61 al litro."),
 ("Birra","Pam","pamextra24","Bevande",'Birra 0.0 – Heineken, lattina',"330 ml",0.330,0.99,16,V,"Solo con l'app Pam Perte Plus. Analcolica. Il volantino stampa 3,00 al litro."),
 ...
 ("Vino","Pam","pamextra24","Bevande",'Vino bianco o rosso – Tavernello, brik',"750 ml (3 × 250 ml)",0.750,1.69,17,V,"Solo con l'app Pam Perte Plus. Il volantino stampa 2,25 al litro."),
 ...
 ("Dentifricio","Pam","pamextra24","Igiene",'Dentifricio menta fresca – Aquafresh, doppio formato',"150 ml (2 × 75 ml)",0.150,1.99,24,V,""),
 ...
 ("Prosciutto","Conad","conad24","Gastronomia",'Prosciutto cotto Gran Biscotto Delì – Rovagnati',"all'etto",0.1,2.19,4,V,"Al banco."),
 ...
 ("Affettati","Conad","conad24","Gastronomia",'Petto di tacchino al forno – Kometa',"all'etto",0.1,1.99,4,V,"Al banco."),
 ...
 ("Affettati","Conad","conad24","Gastronomia","Roast beef di fesa all'inglese – Conad","all'etto",0.1,3.49,5,V,"Al banco, già cotto."),
 ("Formaggio","Conad","conad24","Gastronomia",'Formaggio Maasdam – Conad',"all'etto",0.1,0.99,5,V,"Al banco. «Bassi e fissi»."),
 ("Preparati","Conad","conad24","Gastronomia",'Cotolette con filetti di pollo – Gustosamente Conad',"all'etto",0.1,1.49,5,V,"Al banco, già pronte."),
 ("Pane","Conad","conad24","Panetteria",'Focaccia con olio extra vergine di oliva – Conad, farina 100% italiana',"135 g",0.135,1.90,5,V,"Il volantino dà il prezzo sull'esempio della focaccia all'olio da 135 g (14,08 al kg): ci sono altri tipi e pesi."),
 ...
 ("Preparati","Conad","conad24","Macelleria",'Hamburger di Chianina – Sapori&Dintorni Conad',"200 g (2 × 100 g)",0.200,4.79,6,V,"Il volantino stampa 23,95 al kg."),
 ...
 ("Preparati","Conad","conad24","Macelleria",'Bombette di suino con bacon e formaggio – Conad',"200 g",0.200,2.19,6,V,"Sconto del 30%: prima 3,14. Il volantino stampa 10,95 al kg."),
 ("Salsiccia","Conad","conad24","Macelleria",'Salsicce di pollo – Amadori, tacchino e suino',"650 g",0.650,4.74,6,V,"Sconto del 50%: prima 9,49. Il volantino stampa 7,30 al kg."),
 ...
 ("Preparati","Conad","conad24","Macelleria",'Bon Roll – AIA, classico o con speck',"680 g",0.680,6.95,6,V,"Sconto del 40%: prima 11,59. È un arrosto di tacchino. Il volantino stampa 10,23 al kg."),
 ...
 ("Pasta","Conad","conad24","Freschi",'Pasta fresca di semola di grano duro italiano – Conad, trofie o orecchiette',"500 g",0.500,1.39,10,V,"«Bassi e fissi». Il volantino stampa 2,78 al kg."),
 ...
 ("Spalmabili","Conad","conad24","Freschi",'Vegetale – Philadelphia',"145 g",0.145,2.29,10,V,"È vegetale, non di latte. Il volantino stampa 15,80 al kg."),
 ...
 ("Salmone affumicato","Conad","conad24","Freschi",'Salmone norvegese affumicato Fjordisalmone – Riunione',"100 g",0.100,2.98,11,V,"Sconto del 40%: prima 4,98."),
 ...
 ("Affettati","Conad","conad24","Salumi",'Affettati – Conad Piacersi, vari tipi (per esempio petto di pollo al forno)',"100 g",0.100,1.39,11,V,"È un affettato di petto di pollo al forno, carne italiana; gli altri tipi della linea allo stesso prezzo."),
 ...
 ("Panati","Conad","conad24","Surgelati",'Bastoncini di filetti di merluzzo – Frosta, 15 pezzi',"450 g",0.450,4.39,12,V,"Solo con la Carta Insieme Conad. Senza tessera 6,24, cioè 13,87 al kg."),
 ...
 ("Preparati","Conad","conad24","Freschi",'Teneroni – Granterre, vari tipi (per esempio classici)',"150 g",0.150,2.09,12,V,"Solo con la Carta Insieme Conad. Senza tessera 2,35, cioè 15,67 al kg. Sono hamburger di carne mista: il volantino non dice di quale."),
 ...
 ("Gelato","Conad","conad24","Surgelati",'Gelato pralinato alla vaniglia con amarena – Conad, 6 pezzi',"360 g",0.360,2.99,13,V,"«Bassi e fissi». Il volantino stampa 8,31 al kg."),
 ...
 ("Tonno","Conad","conad24","Dispensa","Filetti di tonno lavorati a mano – Rio Mare, all'olio di oliva, vaso di vetro","180 g",0.180,4.39,14,V,"Solo con la Carta Insieme Conad. Senza tessera 5,99, cioè 33,28 al kg. Il conto è sul peso del vaso, come fa il volantino (24,39 al kg)."),
 ("Tonno","Conad","conad24","Dispensa","Tonno all'olio d'oliva o al naturale – Mareblu, formato speciale","480 g (8 × 60 g)",0.480,6.64,14,V,"Solo con la Carta Insieme Conad. Senza tessera 8,15, cioè 16,98 al kg. Il conto è sul peso delle scatolette, come fa il volantino (13,84 al kg)."),
 ("Conserve","Conad","conad24","Dispensa","Filetto di salmone all'olio di oliva o al naturale – Conad, in scatola","150 g",0.150,3.35,14,V,"«Bassi e fissi». In scatola. Il volantino stampa 22,34 al kg."),
 ...
 ("Cioccolato","Conad","conad24","Dispensa",'Cioccolato -30% di zuccheri – Novi, vari tipi (per esempio al latte)',"100 g",0.100,2.19,15,V,"Solo con la Carta Insieme Conad. Senza tessera 2,59."),
 ...
 ("Cioccolato","Conad","conad24","Dispensa",'Mini fondente Nero Nero (per esempio 88% cacao) – Novi',"140 g",0.140,3.90,15,V,"Solo con la Carta Insieme Conad. Senza tessera 4,49, cioè 32,08 al kg. Il volantino stampa 27,86 al kg."),
 ...
 ("Marmellata","Conad","conad24","Colazione",'Confettura light senza zuccheri aggiunti – Hero, vari tipi',"280 g",0.280,1.95,16,V,"Solo con la Carta Insieme Conad. Senza tessera 2,19, cioè 7,83 al kg."),
 ...
 ("Carta igienica","Conad","conad24","Cura casa",'Carta igienica salvaspazio – Conad',"10 rotoli",10,2.79,19,V,"«Bassi e fissi»."),
...
# LA CARNE LAVORATA NON STA CON QUELLA FRESCA (Manlio, 2026-09-23). Il «meno
# caro» del Suino erano i würstel, quello del Manzo le polpettine: un bollino
# verde che manda a comprare la cosa sbagliata. Adesso hanno categorie loro
# (Würstel, Preparati, Affettati, Panati, Salmone affumicato, Collutorio) e
# questo controllo ferma chi ce le rimette per sbaglio leggendo un volantino.
import re as _re
_LAVORATI = {
    ('Manzo', 'Vitello', 'Suino', 'Pollo', 'Tacchino'):
        r'w[üu]rstel|hamburger|burger|polpett|cotolett|cordon|nuggets|spiedin|bombett|kebab|rollé|al forno|arrosto a fette|affettat',
    ('Merluzzo', 'Pesce', 'Calamari', 'Gamberi', 'Salmone'):
        r'panat|impanat|croccol|croccant|burger|pastella|tempura|fritto misto|bastoncin',
    ('Salmone',): r'affumicat',
    ('Dentifricio',): r'collutorio',
}
# Carne fresca che si chiama come un preparato: le «cotolette e nodini» del
# macellaio sono costolette, non cotolette impanate.
_FRESCHI_OMONIMI = r'cotolette e nodini'
for _p in PRODOTTI:
    for _cats, _rx in _LAVORATI.items():
        if (_p[0] in _cats and _re.search(_rx, _p[4], _re.I)
                and not _re.search(_FRESCHI_OMONIMI, _p[4], _re.I)):
            raise SystemExit('prodotto lavorato nella categoria sbagliata (%s): %s' % (_p[0], _p[4]))
