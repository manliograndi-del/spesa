...
SCARTATE = {
 ...
 'aldi28': {
   2: 'indice del volantino, nessun prezzo',
   3: 'pubblicità, nessun prezzo',
   24: 'non alimentare: abbigliamento (giacche)',
   25: 'non alimentare: abbigliamento e borse',
   26: 'non alimentare: ufficio (zaino, raccoglitori, carta, cuscini)',
   27: 'non alimentare: abbigliamento (pigiami, felpe, scarpe)',
   28: 'non alimentare: decorazioni autunnali, paraspifferi, zerbini',
   29: 'non alimentare: casa (coperte, candele, cuscini, fermaporta)',
   30: 'non alimentare: cucina (piatti, pentole, contenitori), lampada, giocattoli',
   31: 'non alimentare: lampade, cuffie, fotocamera, batterie, piastrelle',
   32: 'non alimentare: accessori per auto',
