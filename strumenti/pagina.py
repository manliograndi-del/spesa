...
(async () => {
  ...
  if (ART) {
    ...
    /* Se sono arrivati prodotti nuovi, dirlo: altrimenti compaiono dei bottoni
       in piu senza che si capisca da dove. */
    stato(arrivati.length
      ? 'Aggiunti alla tua lista: ' + arrivati.join(', ') + '.'
      : 'Questa copia è solo tua: le modifiche restano su questo telefono.');
  }
