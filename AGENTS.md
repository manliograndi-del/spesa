...
**Da fare**
- **Il visore Esselunga dentro la pagina** (toccando un'offerta Esselunga) da
  qui non si è mai caricato fino in fondo, perché il sito risponde a fatica:
  va chiesto a Manlio se sul telefono si vede la pagina del volantino. Se no,
  si passa alle immagini delle pagine (ma su molte manca il testo, vedi la
  tabella delle fonti).
