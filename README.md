...
grandi dei volantini il computer non le legge.

`NOTE.md` è la memoria del progetto: come funziona, perché è fatto così, e le
trappole già pagate. Leggilo prima di toccare qualcosa.
`strumenti/` sono i programmi che scaricano i volantini, li leggono e
ricostruiscono la pagina.
